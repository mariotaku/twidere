...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public CharSequence getPullLabel(final Mode mode) {
	...
	public CharSequence getRefreshingLabel(final Mode mode) {
		return getLoadingLayoutProxy(mode.showHeaderLoadingLayout(), mode.showFooterLoadingLayout())
				.getRefreshingLabel();
	}

	public CharSequence getReleaseLabel(final Mode mode) {
