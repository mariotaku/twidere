...
public class SimpleDragSortCursorAdapter extends ResourceDragSortCursorAdapter {
	 ...
	 */
	@Deprecated
	public SimpleDragSortCursorAdapter(final Context context, final int layout, final Cursor c, final String[] from,
			final int[] to) {
	...
	public CharSequence convertToString(final Cursor cursor) {
		...
		else if (mStringConversionColumn > -1) return cursor.getString(mStringConversionColumn);
	 ...
	 */
	private void findColumns(final Cursor c, final String[] from) {
		if (c != null) {
			int i;
