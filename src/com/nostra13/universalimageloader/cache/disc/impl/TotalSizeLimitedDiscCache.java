...
public class TotalSizeLimitedDiscCache extends LimitedDiscCache {
	 ...
	 */
	public TotalSizeLimitedDiscCache(final File cacheDir, final FileNameGenerator fileNameGenerator,
	 ...
	 *            usage date will be deleted.
	 */
	public TotalSizeLimitedDiscCache(final File cacheDir, final int maxCacheSize) {
