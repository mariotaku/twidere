...
public final class DisplayImageOptions {
	...
	public static class Builder {
		 ...
		 */
		public Builder bitmapConfig(final Bitmap.Config bitmapConfig) {
		...
		public Builder cacheOnDisc(final boolean cacheOnDisc) {
			this.cacheOnDisc = cacheOnDisc;
			return this;
		}

		/** Sets all options equal to incoming options */
		public Builder cloneFrom(final DisplayImageOptions options) {
		 ...
		 * option.
		 */
		public Builder decodingOptions(final Options decodingOptions) {
		...
		public Builder delayBeforeLoading(final int delayInMillis) {
		 ...
		 */
		public Builder extraForDownloader(final Object extra) {
		 ...
		 */
		public Builder showImageForEmptyUri(final int imageRes) {
		 ...
		 * @param imageRes Image resource
		 */
		public Builder showImageOnFail(final int imageRes) {
		 ...
		 */
		public Builder showStubImage(final int stubImageRes) {
