...
public class ImageLoader {
    ...
    public void displayImage(final String uri, final ImageView imageView,
        ...
        if (bmp != null && !bmp.isRecycled()) {
            ...
            if (options.shouldPostProcess()) {
                final ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri, imageView,
                        targetSize,
                        memoryCacheKey, options, listener, engine.getLockForUri(uri));
                final ProcessAndDisplayImageTask displayTask = new ProcessAndDisplayImageTask(
                        engine, bmp,
            ...
            final LoadAndDisplayImageTask displayTask = new LoadAndDisplayImageTask(engine,
                    imageLoadingInfo,
                    options.getHandler());
            engine.submit(displayTask);
        }
     ...
     *             method wasn't called before
     */
    public void loadImage(final String uri, final DisplayImageOptions options,
            final ImageLoadingListener listener) {
    ...
    public void loadImage(final String uri, ImageSize targetImageSize, DisplayImageOptions options,
        ...
        fakeImage.setLayoutParams(new LayoutParams(targetImageSize.getWidth(), targetImageSize
                .getHeight()));
     ...
     *             method wasn't called before
     */
    public void loadImage(final String uri, final ImageSize minImageSize,
            final ImageLoadingListener listener) {
