...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * </ul>
		 */
		public Builder discCache(final DiscCacheAware discCache) {
		 ...
		 *            in disc cache
		 */
		public Builder discCacheExtraOptions(final int maxImageWidthForDiscCache, final int maxImageHeightForDiscCache,
				final CompressFormat compressFormat, final int compressQuality,
				final BitmapProcessor processorForDiscCache) {
			...
			imageQualityForDiscCache = compressQuality;
		 ...
		 */
		public Builder discCacheFileCount(final int maxFileCount) {
			...
			discCacheSize = 0;
			discCacheFileCount = maxFileCount;
			return this;
		}
		 ...
		 * implementation of {@link DiscCacheAware}
		 */
		public Builder discCacheSize(final int maxCacheSize) {
		 ...
		 * </ul>
		 */
		public Builder memoryCache(final MemoryCacheAware<String, Bitmap> memoryCache) {
		 ...
		 */
		public Builder memoryCacheExtraOptions(final int maxImageWidthForMemoryCache,
				final int maxImageHeightForMemoryCache) {
		 ...
		 * implementation of {@link MemoryCacheAware}.
		 */
		public Builder memoryCacheSizePercentage(final int avaialbleMemoryPercent) {
		 ...
		 */
		public Builder taskExecutorForCachedImages(final Executor executorForCachedImages) {
			if (threadPoolSize != DEFAULT_THREAD_POOL_SIZE || threadPriority != DEFAULT_THREAD_PRIORITY
					|| tasksProcessingType != DEFAULT_TASK_PROCESSING_TYPE) {
				L.w(WARNING_OVERLAP_EXECUTOR);
			}
