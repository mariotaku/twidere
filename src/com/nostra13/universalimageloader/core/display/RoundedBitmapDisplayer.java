...
public class RoundedBitmapDisplayer implements BitmapDisplayer {
     ...
     */
    public static Bitmap roundCorners(final Bitmap bitmap, final ImageView imageView,
    ...
    private static Bitmap getRoundedCornerBitmap(final Bitmap bitmap, final int roundPixels,
            final Rect srcRect,
