...
public class RoundedBitmapDisplayer implements BitmapDisplayer {
	...
	public RoundedBitmapDisplayer(final int roundPixels) {
		this.roundPixels = roundPixels;
	}

	@Override
	public Bitmap display(final Bitmap bitmap, final ImageView imageView, final LoadedFrom loadedFrom) {
		final Bitmap roundedBitmap = roundCorners(bitmap, imageView, roundPixels);
	 ...
	 */
	public static Bitmap roundCorners(final Bitmap bitmap, final ImageView imageView, final int roundPixels) {
		Bitmap roundBitmap;
	...
	private static Bitmap getRoundedCornerBitmap(final Bitmap bitmap, final int roundPixels, final Rect srcRect,
			final Rect destRect, final int width, final int height) {
