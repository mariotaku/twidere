...
public interface ImageDownloader {
	...
	public enum Scheme {
		...
		public String crop(final String uri) {
			if (!belongsTo(uri))
		...
		public String wrap(final String path) {
			return uriPrefix + path;
		}

		private boolean belongsTo(final String uri) {
		 ...
		 */
		public static Scheme ofUri(final String uri) {
			if (uri != null) {
				for (final Scheme s : values()) {
