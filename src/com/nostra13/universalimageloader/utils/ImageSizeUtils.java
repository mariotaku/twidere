...
public final class ImageSizeUtils {
	...
	public static float computeImageScale(final ImageSize srcSize, final ImageSize targetSize,
		...
		float scale = 1;
		if (!stretch && destWidth < srcWidth && destHeight < srcHeight || stretch && destWidth != srcWidth
	 ...
	 */
	public static ImageSize defineTargetSizeForView(final ImageView imageView, final int maxImageWidth,
