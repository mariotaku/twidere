...
public final class ImageSizeUtils {
     ...
     */
    public static int computeImageSampleSize(final ImageSize srcSize, final ImageSize targetSize,
            final ViewScaleType viewScaleType, final boolean powerOf2Scale) {
        ...
        final int widthScale = srcWidth / targetWidth;
        final int heightScale = srcHeight / targetHeight;
     ...
     */
    public static float computeImageScale(final ImageSize srcSize, final ImageSize targetSize,
            final ViewScaleType viewScaleType, final boolean stretch) {
     ...
     */
    public static ImageSize defineTargetSizeForView(final ImageView imageView,
        ...
        int width = params != null && params.width == LayoutParams.WRAP_CONTENT ? 0 : imageView
                .getWidth();
        ...
        int height = params != null && params.height == LayoutParams.WRAP_CONTENT ? 0 : imageView
                .getHeight(); // Get
                              // actual
                              // image
                              // height
    ...
    private static int getImageViewFieldValue(final Object object, final String fieldName) {
        int value = 0;
        try {
            final Field field = ImageView.class.getDeclaredField(fieldName);
            field.setAccessible(true);
            final int fieldValue = (Integer) field.get(object);
