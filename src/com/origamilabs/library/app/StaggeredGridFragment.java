...
package com.origamilabs.library.app;
...
public class StaggeredGridFragment extends Fragment {
	...
	/**
	 * Get the ListAdapter associated with this activity's StaggeredGridView.
	 */
	 ...
	 * getStaggeredGridView().getItemAtPosition(position) if they need to access
	 * the data associated with the selected item.
	 * 
	 * @param l The StaggeredGridView where the click happened
	 * @param v The view that was clicked within the StaggeredGridView
	...
	public final void setColumnCount(final int colCount) {
		ensureList();
		mList.setColumnCount(colCount);
	}
	...
	private void ensureList() {
		...
		if (root instanceof StaggeredGridView) {
			...
			final View rawStaggeredGridView = root.findViewById(android.R.id.list);
			if (!(rawStaggeredGridView instanceof StaggeredGridView)) {
				if (rawStaggeredGridView == null)
			...
			mList = (StaggeredGridView) rawStaggeredGridView;
			if (mEmptyView != null) {
