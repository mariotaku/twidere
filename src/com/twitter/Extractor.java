...
public class Extractor {
    ...
    public List<Entity> extractCashtagsWithIndices(final String text) {
        ...
        while (matcher.find()) {
            extracted.add(new Entity(matcher, Entity.Type.CASHTAG,
                    Regex.VALID_CASHTAG_GROUP_CASHTAG_FULL));
        }
    ...
    public Set<String> extractMentionedScreennames(final String text,
            final boolean exclude_duplicate) {
        if (text == null || text.length() == 0)
        ...
        while (matcher.find()) {
            ...
            if (!Regex.INVALID_MENTION_MATCH_END.matcher(after).find()) {
                if (matcher.group(Regex.VALID_MENTION_OR_LIST_GROUP_LIST) == null) {
                    ...
                    extracted.add(new Entity(matcher
                            .start(Regex.VALID_MENTION_OR_LIST_GROUP_USERNAME) - 1, matcher
    ...
    public static class Entity {
        ...
        public Entity(final int start, final int end, final String value, final String listSlug,
                final Type type) {
            this.start = start;
            this.end = end;
            this.value = value;
        ...
        public Entity(final Matcher matcher, final Type type, final int groupNumber,
            ...
            this(matcher.start(groupNumber) + startOffset, matcher.end(groupNumber), matcher
                    .group(groupNumber), type);
        }
        ...
        public boolean equals(final Object obj) {
            ...
            if (type.equals(other.type) && start == other.start && end == other.end
    ...
    private static final class IndexConverter {
        ...
        int codeUnitsToCodePoints(final int charIndex) {
            ...
            // surrogate pair.
            if (charIndex > 0
                    && Character.isSupplementaryCodePoint(text.codePointAt(charIndex - 1))) {
                this.charIndex -= 1;
            }
