...
public final class Crouton {
   ...
   */
  private Crouton(Activity activity, CharSequence text, CroutonStyle style) {
   ...
   */
  private Crouton(Activity activity, CharSequence text, CroutonStyle style, ViewGroup viewGroup) {
    if ((activity == null) || (text == null) || (style == null)) {
      throw new IllegalArgumentException("Null parameters are not accepted");
    }
  ...
  private Crouton(Activity activity, View customView) {
    ...
    this.style = new CroutonStyle.Builder().build();
    this.text = null;
  }
   ...
   */
  public static Crouton makeText(Activity activity, CharSequence text, CroutonStyle style) {
   ...
   * @return The created {@link Crouton}.
   */
  public static Crouton makeText(Activity activity, CharSequence text, CroutonStyle style, ViewGroup viewGroup) {
   ...
   * @return The created {@link Crouton}.
   */
  public static Crouton makeText(Activity activity, CharSequence text, CroutonStyle style, int viewGroupResId) {
   ...
   * @return The created {@link Crouton}.
   */
  public static Crouton makeText(Activity activity, int textResourceId, CroutonStyle style) {
   ...
   * @return The created {@link Crouton}.
   */
  public static Crouton makeText(Activity activity, int textResourceId, CroutonStyle style, ViewGroup viewGroup) {
   ...
   * @return The created {@link Crouton}.
   */
  public static Crouton makeText(Activity activity, int textResourceId, CroutonStyle style, int viewGroupResId) {
    return makeText(activity, activity.getString(textResourceId), style,
   ...
   *   The style that this {@link Crouton} should be created with.
   */
  public static void showText(Activity activity, CharSequence text, CroutonStyle style) {
   ...
   *   The {@link ViewGroup} that this {@link Crouton} should be added to.
   */
  public static void showText(Activity activity, CharSequence text, CroutonStyle style, ViewGroup viewGroup) {
   ...
   *   The resource id of the {@link ViewGroup} that this {@link Crouton} should be added to.
   */
  public static void showText(Activity activity, CharSequence text, CroutonStyle style, int viewGroupResId) {
   ...
   *   The style that this {@link Crouton} should be created with.
   */
  public static void showText(Activity activity, int textResourceId, CroutonStyle style) {
   ...
   *   The {@link ViewGroup} that this {@link Crouton} should be added to.
   */
  public static void showText(Activity activity, int textResourceId, CroutonStyle style, ViewGroup viewGroup) {
   ...
   *   The resource id of the {@link ViewGroup} that this {@link Crouton} should be added to.
   */
  public static void showText(Activity activity, int textResourceId, CroutonStyle style, int viewGroupResId) {
  ...
  public void cancel() {
    CroutonManager manager = CroutonManager.getInstance();
   ...
   */
  public void setLifecycleCallback(CroutonLifecycleCallback lifecycleCallback) {
