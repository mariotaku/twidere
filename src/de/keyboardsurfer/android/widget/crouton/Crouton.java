...
public final class Crouton {
    ...
    public String toString() {
        return "Crouton{" + "text=" + text + ", style=" + style + ", configuration="
                + configuration + ", customView="
                + customView + ", onClickListener=" + onClickListener + ", activity=" + activity
                + ", viewGroup="
                + viewGroup + ", croutonView=" + croutonView + ", inAnimation=" + inAnimation
                + ", outAnimation="
    ...
    private FrameLayout initializeCroutonViewGroup(final Resources resources) {
        ...
        if (style.backgroundDrawableResourceId != 0) {
            final Bitmap background = BitmapFactory.decodeResource(resources,
                    style.backgroundDrawableResourceId);
     ...
     * @return The created {@link Crouton}.
     */
    public static Crouton makeText(final Activity activity, final CharSequence text,
            final CroutonStyle style) {
     ...
     * @return The created {@link Crouton}.
     */
    public static Crouton makeText(final Activity activity, final int textResourceId,
            final CroutonStyle style) {
     ...
     * @param style The style that this {@link Crouton} should be created with.
     */
    public static void showText(final Activity activity, final CharSequence text,
            final CroutonStyle style) {
     ...
     * @param style The style that this {@link Crouton} should be created with.
     */
    public static void showText(final Activity activity, final int textResourceId,
            final CroutonStyle style) {
