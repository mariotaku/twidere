...
public class Compatibility {
	 ...
	 * 
	 */
	static String getDropBoxServiceName() throws SecurityException, NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException {
		final Field serviceName = Context.class.getField("DROPBOX_SERVICE");
		if (serviceName != null) return (String) serviceName.get(null);
		return null;
	}
}
