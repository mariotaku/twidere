...
class LogCatCollector {
	 ...
	 * 
	 * @param bufferName The name of the buffer to be read: "main" (default),
	 *            "radio" or "events".
	...
	protected static String collectLogCat(String bufferName) {
		...
		try {
			...
			int tailCount = -1;
			final List<String> logcatArgumentsList = new ArrayList<String>(Arrays.asList(ACRA.getConfig()
					.logcatArguments()));
