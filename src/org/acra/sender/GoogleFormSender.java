...
public class GoogleFormSender implements ReportSender {
	 ...
	 * by its key.
	 * 
	 * @param formKey The key of the form. The key is the formKey parameter
	 *            value in the Form Url:
	 *            https://spreadsheets.google.com/viewform
	 *            ?formkey=<b>dDN6NDdnN2I2aWU1SW5XNmNyWVljWmc6MQ</b>
	 */
	...
	private Map<String, String> remap(Map<ReportField, String> report) {
		...
		for (final Object originalKey : fields) {
