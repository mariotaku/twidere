...
public interface ReportSender {
	 ...
	 * 
	 * @param errorContent Stores key/value pairs for each report field. A
	 *            report field is identified by a {@link ReportField} enum
	 *            value.
	 * @throws ReportSenderException If anything goes fatally wrong during the
	 *             handling of crash data, you can (should) throw a
	 *             {@link ReportSenderException} with a custom message.
	 */
