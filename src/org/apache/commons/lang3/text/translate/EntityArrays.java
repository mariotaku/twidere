...
public class EntityArrays {
    ...
    private static final String[][] HTML40_EXTENDED_ESCAPE = {
            ...
            {
                    "\u2205", "&empty;"
            }, // empty set = null set = diameter,U+2205
               // ISOamso -->
            {
                    "\u2207", "&nabla;"
            ...
            {
                    "\u2248", "&asymp;"
            }, // almost equal to = asymptotic to,U+2248
               // ISOamsr -->
            {
                    "\u2260", "&ne;"
            ...
            {
                    "\u2297", "&otimes;"
            }, // circled times = vector product,U+2297
               // ISOamsb -->
            {
                    "\u22A5", "&perp;"
            ...
            {
                    "\u2329", "&lang;"
            }, // left-pointing angle bracket = bra,U+2329
               // ISOtech -->
            ...
            {
                    "\u232A", "&rang;"
            }, // right-pointing angle bracket = ket,U+232A
               // ISOtech -->
            ...
            {
                    "\u2665", "&hearts;"
            }, // black heart suit = valentine,U+2665
               // ISOpub -->
            {
                    "\u2666", "&diams;"
