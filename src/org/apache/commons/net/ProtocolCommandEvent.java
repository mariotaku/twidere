...
public class ProtocolCommandEvent extends EventObject {
	 ...
	 * @param replyCode The integer code indicating the natureof the reply. This
	 *            will be the protocol integer value for protocols that use
	 *            integer reply codes, or the reply class constant corresponding
	 *            to the reply for protocols like POP3 that use strings like OK
	 *            rather than integer codes (i.e., POP3Repy.OK).
