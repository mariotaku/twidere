...
public class FTPClientConfig {
	 ...
	 *            connected to. See {@link #getServerSystemKey()
	 *            serverSystemKey}
	 */
	 ...
	 * @param recentDateFormatStr See {@link #setRecentDateFormatStr(String)
	 *            recentDateFormatStr}
	 * @param serverLanguageCode See {@link #setServerLanguageCode(String)
	 *            serverLanguageCode}
	 * @param shortMonthNames See {@link #setShortMonthNames(String)
	 *            shortMonthNames}
	 * @param serverTimeZoneId See {@link #setServerTimeZoneId(String)
	 *            serverTimeZoneId}
	 */
	public FTPClientConfig(final String systemKey, final String defaultDateFormatStr, final String recentDateFormatStr,
			final String serverLanguageCode, final String shortMonthNames, final String serverTimeZoneId) {
		this(systemKey);
	...
	public static DateFormatSymbols lookupDateFormatSymbols(final String languageCode) {
		...
		if (lang != null) {
			...
			else if (lang instanceof String) return getDateFormatSymbols((String) lang);
		}
