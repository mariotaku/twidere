...
public final class FTPCommand {
	...
	private static final String[] _commands = { "USER", "PASS", "ACCT", "CWD", "CDUP", "SMNT", "REIN", "QUIT", "PORT",
			"PASV", "TYPE", "STRU", "MODE", "RETR", "STOR", "STOU", "APPE", "ALLO", "REST", "RNFR", "RNTO", "ABOR",
			"DELE", "RMD", "MKD", "PWD", "LIST", "NLST", "SITE", "SYST", "STAT", "HELP", "NOOP", "MDTM", "FEAT",
			"MFMT", "EPSV", "EPRT", "MLSD", "MLST" };
	...
	static void checkArray() {
		...
		if (_commands.length != expectedLength)
			throw new RuntimeException("Incorrect _commands array. Should have length " + expectedLength + " found "
					+ _commands.length);
	}
}
