...
public abstract class ConfigurableFTPFileEntryParserImpl extends RegexFTPFileEntryParserImpl implements Configurable {
	 ...
	 * 
	 * @param config the configuration to be used to configure this parser. If
	 *            it is null, a default configuration defined by each concrete
	 ...
	 * <p>
	 * 
	 * @param timestampStr the timestamp string pulled from the file listing by
	 *            the regular expression parser, to be submitted to the
