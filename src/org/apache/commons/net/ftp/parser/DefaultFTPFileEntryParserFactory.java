...
public class DefaultFTPFileEntryParserFactory implements FTPFileEntryParserFactory {
	 ...
	 * </p>
	 * 
	 * @param config A {@link FTPClientConfig FTPClientConfig} used to configure
	 *            the parser created
	 * 
	 * @return the @link FTPFileEntryParser FTPFileEntryParser} so created.
	 * @exception ParserInitializationException Thrown on any exception in
	 *                instantiation
	 ...
	 * <p/>
	 * 
	 * @param key should be a fully qualified classname corresponding to a class
	 ...
	 *             factory cannot resolve the supplied key into an
	 *             FTPFileEntryParser.
	 * @see FTPFileEntryParser
	 */
	@Override
	public FTPFileEntryParser createFileEntryParser(final String key) {
		if (key == null) throw new ParserInitializationException("Parser key cannot be null");
