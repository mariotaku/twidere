...
public class PhotoViewAdapter implements PhotoView.ITileImageAdapter {
    ...
    @Override
    public Bitmap getTile(final int level, final int x, final int y, final int tileSize,
    ...
    @Override
    public boolean setData(final BitmapRegionDecoder decoder, final Bitmap bitmap,
            final int oroentation) {
        try {
            if (decoder != null) {
    ...
    private Bitmap getTileWithoutReusingBitmap(final int level, final int x, final int y,
            final int tileSize,
            final int borderSize) {
        final int b = borderSize << level;
        final int t = tileSize << level;
    ...
    private synchronized void setScreenNail(final ScreenNail screenNail, final int width,
            final int height) {
