...
public class GLView {
    ...
    protected void renderChild(final GLCanvas canvas, final GLView component) {
        if (component.getVisibility() != GLView.VISIBLE && component.mAnimation == null)
            return;
    ...
    private boolean dispatchTouchEvent(final MotionEvent event, final int x, final int y,
            final GLView component,
