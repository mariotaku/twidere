...
class GalleryEGLConfigChooser implements EGLConfigChooser {
    ...
    private static final int[] ATTR_ID = {
            EGL10.EGL_RED_SIZE, EGL10.EGL_GREEN_SIZE, EGL10.EGL_BLUE_SIZE,
            EGL10.EGL_ALPHA_SIZE, EGL10.EGL_DEPTH_SIZE, EGL10.EGL_STENCIL_SIZE,
            EGL10.EGL_CONFIG_ID,
    ...
    private EGLConfig chooseConfig(final EGL10 egl, final EGLDisplay display,
