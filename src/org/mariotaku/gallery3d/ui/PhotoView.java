...
public class PhotoView extends GLView {
    ...
    private class GestureListener implements GestureRecognizer.Listener {
        ...
        @Override
        public boolean onScroll(final float dx, final float dy, final float totalX,
                final float totalY) {
    ...
    class FullPicture implements Picture {
        ...
        private void setTileViewPosition(final float cx, final float cy, final int viewW,
                final int viewH,
                final float scale) {
