...
public class BitmapUtils {
    ...
    public static int computeSampleSize(final float scale) {
        ...
        return initialSize <= 8 ? GalleryUtils.nextPowerOf2(initialSize)
                : (initialSize + 7) / 8 * 8;
    }
    ...
    public static Bitmap resizeDownIfTooBig(final Bitmap bitmap, final int targetSize,
    ...
    private static Bitmap resizeBitmapByScale(final Bitmap bitmap, final float scale,
            final boolean recycle) {
