...
public class JSONSerializer {
    ...
    public static <T extends JSONParcelable> T[] fromJSON(final JSONParcelable.Creator<T> creator,
    ...
    public static File getSerializationFile(final Context context, final Object... args)
            throws IOException {
    ...
    public static <T extends JSONParcelable> List<T> listFromFile(final File file)
            throws IOException {
        if (file == null)
            throw new FileNotFoundException();
        final BufferedReader reader = new BufferedReader(new FileReader(file));
    ...
    public static <T extends JSONParcelable> List<T> listFromJSON(
            final JSONParcelable.Creator<T> creator,
            final JSONArray json) {
        if (json == null)
            return null;
        final int size = json.length();
    ...
    public static <T extends JSONParcelable> void toFile(final File file, final T parcelable)
            throws IOException {
        if (file == null || parcelable == null)
            return;
    ...
    public static <T extends JSONParcelable> void toFile(final File file, final T[] array)
            throws IOException {
