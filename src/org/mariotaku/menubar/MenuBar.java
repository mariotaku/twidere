...
public class MenuBar extends LinearLayout implements PopupMenu.OnMenuItemClickListener {
    ...
    public void setStretchButtonsEnabled(final boolean enabled) {
        if (mStretchButtonsEnabled == enabled)
            return;
    ...
    private View addMenuButton(final MenuItem item) {
        ...
        final ImageButton actionButton = new ImageButton(mContext, null,
        ...
        actionButton.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(final View v) {
                ...
                t.setGravity(Gravity.TOP | Gravity.LEFT, screenPos[0],
                        (int) (screenPos[1] - height * 1.5));
                t.show();
                return true;
            }
        });
