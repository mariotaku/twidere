...
public interface Constants extends TwitterConstants {
	...
	public static final String BROADCAST_RESCHEDULE_HOME_TIMELINE_REFRESHING = INTENT_PACKAGE_PREFIX + "RESCHEDULE_REFRESH_HOME_TIMELINE";
	public static final String BROADCAST_RESCHEDULE_MENTIONS_REFRESHING = INTENT_PACKAGE_PREFIX + "RESCHEDULE_REFRESH_MENTIONS";
	public static final String BROADCAST_RESCHEDULE_DIRECT_MESSAGES_REFRESHING = INTENT_PACKAGE_PREFIX + "RESCHEDULE_DIRECT_MESSAGES_REFRESHING";
