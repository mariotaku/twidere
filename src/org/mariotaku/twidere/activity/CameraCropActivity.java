    ...
    protected void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_TAKE_PHOTO: {
                ...
                final int aspectX = intent.getIntExtra(EXTRA_ASPECT_X, 1), aspectY = intent
                        .getIntExtra(EXTRA_ASPECT_Y,
                                1);
                final int outputX = intent.getIntExtra(EXTRA_OUTPUT_X, 512), outputY = intent
                        .getIntExtra(
                                EXTRA_OUTPUT_Y, 512);
                final boolean scaleUpIfNeeded = intent.getBooleanExtra(EXTRA_SCALE_UP_IF_NEEDED,
                        false);
