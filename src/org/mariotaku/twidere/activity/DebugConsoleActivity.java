...
public class DebugConsoleActivity extends BaseActivity implements ActionBar.TabListener {
	...
	private Tab makeTab(String text, Class<? extends Fragment> cls) {
		return mActionBar.newTab().setText(text).setTag(new TabInfo(cls)).setTabListener(this);
	}
	...
	public static class RunningTasksFragment extends BaseListFragment {
		...
		public void onActivityCreated(Bundle savedInstanceState) {
			...
			mAdapter = new TaskListAdapter(getSherlockActivity(), mAsyncTaskManager.getTaskList());
			setListAdapter(mAdapter);
		}

		private static class TaskListAdapter extends ArrayAdapter<ManagedAsyncTask<?>> {

			public TaskListAdapter(Context context, List<ManagedAsyncTask<?>> objects) {
