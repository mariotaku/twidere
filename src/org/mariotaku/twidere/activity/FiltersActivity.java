...
public class FiltersActivity extends BaseActivity implements TabListener, OnPageChangeListener {
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_ADD: {
                ...
                if (!(filter instanceof BaseFiltersFragment))
                    return true;
    ...
    public boolean onPrepareOptionsMenu(final Menu menu) {
        final boolean enable_in_home_timeline = mPreferences.getBoolean(
                PREFERENCE_KEY_FILTERS_IN_HOME_TIMELINE, true);
        final boolean enable_in_mentions = mPreferences.getBoolean(
                PREFERENCE_KEY_FILTERS_IN_MENTIONS, true);
        final boolean enable_for_rts = mPreferences
                .getBoolean(PREFERENCE_KEY_FILTERS_FOR_RTS, true);
    ...
    public static final class AddItemFragment extends BaseDialogFragment implements OnClickListener {
        ...
        public Dialog onCreateDialog(final Bundle savedInstanceState) {
            ...
            final View view = LayoutInflater.from(context).inflate(R.layout.auto_complete_textview,
                    null);
            builder.setView(view);
            mEditText = (AutoCompleteTextView) view.findViewById(R.id.edit_text);
            final Bundle args = getArguments();
            final int auto_complete_type = args != null ? args.getInt(
                    INTENT_KEY_AUTO_COMPLETE_TYPE, 0) : 0;
