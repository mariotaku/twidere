...
public class HostMappingActivity extends BaseSupportActivity implements MultiChoiceModeListener {
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        switch (item.getItemId()) {
            case MENU_HOME:
                ...
                break;
            case MENU_ADD:
                mDialogFragment = (DialogFragment) Fragment.instantiate(this,
    ...
    public static class AddMappingDialogFragment extends BaseDialogFragment implements
        ...
        public void onClick(final DialogInterface dialog, final int which) {
            switch (which) {
                case DialogInterface.BUTTON_POSITIVE: {
                    ...
                    if (isEmpty(mHost) || isEmpty(mAddress))
                        return;
        ...
        public Dialog onCreateDialog(final Bundle savedInstanceState) {
            ...
            final View view = LayoutInflater.from(getActivity()).inflate(
                    R.layout.host_mapping_dialog_view, null);
    ...
    static class HostMappingAdapter extends ArrayAdapter<String> {
        ...
        public HostMappingAdapter(final Context context) {
            ...
            mPreferences = context.getSharedPreferences(HOST_MAPPING_PREFERENCES_NAME,
                    Context.MODE_PRIVATE);
        }
    ...
    static class ImportHostsTask extends AsyncTask<Void, Void, Boolean> {
        ...
        ImportHostsTask(final HostMappingActivity activity, final String path) {
            mActivity = activity;
            mPath = path;
            mPreferences = activity.getSharedPreferences(HOST_MAPPING_PREFERENCES_NAME,
                    Context.MODE_PRIVATE);
        }
