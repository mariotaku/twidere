...
public class RequestPermissionsActivity extends BaseSupportDialogActivity implements
        OnClickListener {
            ...
            if (permissions == 0) {
                ...
                if (permissions % PERMISSION_PREFERENCES == 0) {
                    builder.append("<br/>" + "<b><font color='#FF8000'>"
                            + getString(R.string.permission_description_preferences)
                            + "</font></b>");
                }
                ...
                if (permissions % PERMISSION_DIRECT_MESSAGES == 0) {
                    builder.append("<br/>" + "<b><font color='#FF8000'>"
                            + getString(R.string.permission_description_direct_messages)
                            + "</font></b>");
                }
                if (permissions % PERMISSION_WRITE == 0) {
                    builder.append("<br/>" + "<b>"
                            + getString(R.string.permission_description_write) + "</b>");
                }
