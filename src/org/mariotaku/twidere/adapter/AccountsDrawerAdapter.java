...
public class AccountsDrawerAdapter extends BaseExpandableListAdapter implements Constants {
    ...
    static {
        DEFAULT_ACCOUNT_ACTIONS[0] = new AccountAction(R.string.view_user_profile,
                R.drawable.ic_menu_profile,
                MENU_VIEW_PROFILE);
        DEFAULT_ACCOUNT_ACTIONS[1] = new AccountAction(R.string.statuses, R.drawable.ic_menu_quote,
                MENU_STATUSES);
        DEFAULT_ACCOUNT_ACTIONS[2] = new AccountAction(R.string.favorites, R.drawable.ic_menu_star,
                MENU_FAVORITES);
        DEFAULT_ACCOUNT_ACTIONS[3] = new AccountAction(R.string.user_list, R.drawable.ic_menu_list,
                MENU_LISTS);
        DEFAULT_ACCOUNT_ACTIONS[4] = new AccountAction(R.string.lists_following_user,
                R.drawable.ic_menu_list,
                MENU_LIST_MEMBERSHIPS);
        DEFAULT_ACCOUNT_ACTIONS[5] = new AccountAction(R.string.edit_profile,
                android.R.drawable.ic_menu_edit,
                MENU_EDIT);
        DEFAULT_ACCOUNT_ACTIONS[6] = new AccountAction(R.string.set_color,
                R.drawable.ic_menu_color_palette,
                MENU_SET_COLOR);
        DEFAULT_ACCOUNT_ACTIONS[7] = new AccountAction(R.string.delete,
                android.R.drawable.ic_menu_delete, MENU_DELETE);
        ACCOUNT_ACTIONS[0] = new AccountAction(R.string.view_user_profile,
                R.drawable.ic_menu_profile,
                MENU_VIEW_PROFILE);
        ACCOUNT_ACTIONS[1] = new AccountAction(R.string.statuses, R.drawable.ic_menu_quote,
                MENU_STATUSES);
        ACCOUNT_ACTIONS[2] = new AccountAction(R.string.favorites, R.drawable.ic_menu_star,
                MENU_FAVORITES);
        ACCOUNT_ACTIONS[3] = new AccountAction(R.string.user_list, R.drawable.ic_menu_list,
                MENU_LISTS);
        DEFAULT_ACCOUNT_ACTIONS[4] = new AccountAction(R.string.lists_following_user,
                R.drawable.ic_menu_list,
                MENU_LIST_MEMBERSHIPS);
        ACCOUNT_ACTIONS[5] = new AccountAction(R.string.edit_profile,
                android.R.drawable.ic_menu_edit, MENU_EDIT);
        ACCOUNT_ACTIONS[6] = new AccountAction(R.string.set_color,
                R.drawable.ic_menu_color_palette, MENU_SET_COLOR);
        ACCOUNT_ACTIONS[7] = new AccountAction(R.string.set_as_default, R.drawable.ic_menu_mark,
                MENU_SET_AS_DEFAULT);
        ACCOUNT_ACTIONS[8] = new AccountAction(R.string.delete, android.R.drawable.ic_menu_delete,
                MENU_DELETE);
    }
    ...
    public long getChildId(final int groupPosition, final int childPosition) {
        return Arrays.hashCode(new long[] {
                getGroupId(groupPosition), getChild(groupPosition, childPosition).id
        });
    }
    ...
    public View getGroupView(final int groupPosition, final boolean isExpanded,
        ...
        final int expander_res = isExpanded ? R.drawable.expander_open_holo
                : R.drawable.expander_close_holo;
        ...
        holder.default_indicator
                .setVisibility(mDefaultAccountId == account.account_id ? View.VISIBLE : View.GONE);
    ...
    public void setDefaultAccountId(final long account_id) {
        if (mDefaultAccountId == account_id)
            return;
