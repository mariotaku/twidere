...
public class DirectMessagesConversationAdapter extends SimpleCursorAdapter implements
    ...
    public DirectMessagesConversationAdapter(final Context context) {
        super(context, R.layout.direct_messages_conversation_list_item, null, new String[0],
                new int[0], 0);
        mContext = context;
    ...
    public void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        final DirectMessageConversationViewHolder holder = (DirectMessageConversationViewHolder) view
                .getTag();
        ...
        holder.incoming_profile_image_container.setVisibility(mDisplayProfileImage ? View.VISIBLE
                : View.GONE);
        holder.outgoing_profile_image_container.setVisibility(mDisplayProfileImage ? View.VISIBLE
                : View.GONE);
        if (mDisplayProfileImage) {
            final String profile_image_url_string = cursor
                    .getString(mIndices.sender_profile_image_url);
            mImageLoader.displayProfileImage(holder.incoming_profile_image,
                    profile_image_url_string);
            mImageLoader.displayProfileImage(holder.outgoing_profile_image,
                    profile_image_url_string);
    ...
    public View newView(final Context context, final Cursor cursor, final ViewGroup parent) {
        ...
        if (!(tag instanceof DirectMessageConversationViewHolder)) {
            final DirectMessageConversationViewHolder holder = new DirectMessageConversationViewHolder(
                    view);
            view.setTag(holder);
