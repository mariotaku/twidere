...
public class ImagePreviewAdapter extends ArrayAdapter<PreviewImage> implements Constants {
    ...
    public ImagePreviewAdapter(final Context context) {
        ...
        mImageLoader = ((TwidereApplication) context.getApplicationContext())
                .getImageLoaderWrapper();
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (mIsPossiblySensitive
                && !mPreferences.getBoolean(PREFERENCE_KEY_DISPLAY_SENSITIVE_CONTENTS, false)) {
            ...
            mImageLoader.displayPreviewImage(image_view, spec.image_preview_url,
