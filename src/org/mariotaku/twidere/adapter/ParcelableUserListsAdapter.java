...
public class ParcelableUserListsAdapter extends ArrayAdapter<ParcelableUserList> implements
        IBaseAdapter,
        OnClickListener {
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        final String created_by = mDisplayName ? user_list.user_name : "@"
        ...
        holder.description.setVisibility(TextUtils.isEmpty(user_list.description) ? View.GONE
                : View.VISIBLE);
        ...
        if (mDisplayProfileImage) {
            mProfileImageLoader.displayProfileImage(holder.profile_image,
                    user_list.user_profile_image_url);
        }
        ...
        switch (view.getId()) {
            case R.id.profile_image: {
                if (mContext instanceof Activity) {
                    ...
                    openUserProfile((Activity) mContext, item.account_id, item.user_id,
