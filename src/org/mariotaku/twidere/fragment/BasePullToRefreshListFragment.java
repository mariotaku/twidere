...
public abstract class BasePullToRefreshListFragment extends BaseSupportListFragment implements
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        if (activity instanceof PullToRefreshAttacherActivity) {
            ...
            throw new IllegalStateException(
                    "Activity class must implement PullToRefreshAttacherActivity");
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        if (!(context instanceof PullToRefreshAttacherActivity))
            throw new IllegalStateException(
                    "Activity class must implement PullToRefreshAttacherActivity");
        mPullToRefreshAttacher = ((PullToRefreshAttacherActivity) context)
    ...
    public static interface PullToRefreshAttacherActivity {
        ...
        public void setRefreshing(final BasePullToRefreshListFragment fragment,
