...
abstract class BaseUserListsListFragment extends BasePullToRefreshListFragment implements
        LoaderCallbacks<List<ParcelableUserList>>, Panes.Left, OnMenuItemClickListener,
    ...
    public abstract Loader<List<ParcelableUserList>> newLoaderInstance(long account_id,
    ...
    @Override
    public final void onListItemClick(final ListView view, final View child, final int position,
            final long id) {
    ...
    @Override
    public void onLoadFinished(final Loader<List<ParcelableUserList>> loader,
    ...
    public boolean onMenuItemClick(final MenuItem item) {
        ...
        switch (item.getItemId()) {
            case MENU_VIEW_USER_LIST: {
                openUserListDetails(getActivity(), mAccountId, mSelectedUserList.id,
                        mSelectedUserList.user_id,
