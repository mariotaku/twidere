...
abstract class BaseUsersListFragment extends BasePullToRefreshListFragment implements
        LoaderCallbacks<List<ParcelableUser>>, OnItemLongClickListener, Panes.Left,
    ...
    public void onItemsCleared() {
        ...
        final int position = mListView.getFirstVisiblePosition(), offset = Utils
                .getFirstChildOffset(mListView);
    ...
    protected void setItemSelected(final ParcelableUser user, final int position,
