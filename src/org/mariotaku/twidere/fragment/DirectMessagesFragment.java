...
public class DirectMessagesFragment extends BasePullToRefreshListFragment implements
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (BROADCAST_ACCOUNT_LIST_DATABASE_UPDATED.equals(action)) {
                ...
                setRefreshing(twitter != null
                        && (twitter.isReceivedDirectMessagesRefreshing() || twitter
                                .isSentDirectMessagesRefreshing()));
            }
        }
    };
    ...
    public void onRefreshStarted() {
        ...
        new AsyncTask<Void, Void, long[][]>() {
            ...
            protected long[][] doInBackground(final Void... params) {
                ...
                result[1] = getNewestMessageIdsFromDatabase(getActivity(),
    ...
    private void loadMoreMessages() {
        ...
        new AsyncTask<Void, Void, long[][]>() {
            ...
            protected long[][] doInBackground(final Void... params) {
                ...
                result[0] = getActivatedAccountIds(getActivity());
                result[1] = getOldestMessageIdsFromDatabase(getActivity(),
                        DirectMessages.Inbox.CONTENT_URI);
                result[2] = getOldestMessageIdsFromDatabase(getActivity(),
