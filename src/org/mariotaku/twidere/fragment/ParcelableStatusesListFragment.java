...
public abstract class ParcelableStatusesListFragment extends
        BaseStatusesListFragment<List<ParcelableStatus>> {
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            final List<ParcelableStatus> saved = savedInstanceState
                    .getParcelableArrayList(INTENT_KEY_DATA);
            if (saved != null) {
                setData(saved);
            }
        }
    ...
    protected void saveStatuses() {
        if (getActivity() == null || getView() == null || mIsStatusesSaved)
            return;
