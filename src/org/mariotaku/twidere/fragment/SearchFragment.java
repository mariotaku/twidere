...
public class SearchFragment extends BaseSupportFragment implements Panes.Left,
    ...
    public void hideIndicator() {
        ...
        mIndicator.startAnimation(AnimationUtils.loadAnimation(getActivity(),
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        mAdapter.addTab(SearchTweetsFragment.class, args, getString(R.string.statuses),
    ...
    public void onPageSelected(final int position) {
        final int count = mAdapter.getCount();
        if (count != mIndicator.getChildCount())
            return;
        for (int i = 0; i < count; i++) {
    ...
    public boolean scrollToStart() {
        if (!(mCurrentVisibleFragment instanceof RefreshScrollTopInterface))
            return false;
