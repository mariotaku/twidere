...
public class UserListMembersFragment extends CursorSupportUsersListFragment implements
    ...
    public CursorSupportUsersLoader newLoaderInstance(final Context context, final Bundle args) {
        ...
        return new UserListMembersLoader(context, account_id, list_id, user_id, screen_name,
                list_name,
    ...
    public boolean onItemLongClick(final AdapterView<?> parent, final View view,
        ...
        mSelectedUser = null;
        if (mUserList == null || mUserList.account_id != mUserList.user_id)
            return false;
    ...
    public boolean onMenuItemClick(final MenuItem item) {
        if (mSelectedUser == null || mUserList == null)
            return false;
        switch (item.getItemId()) {
            case MENU_DELETE: {
                mTwitterWrapper.deleteUserListMembers(getAccountId(), mUserList.id,
                        mSelectedUser.id);
                break;
            }
