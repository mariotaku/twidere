...
public class UserMentionsFragment extends SearchTweetsFragment {
    ...
    public Loader<List<ParcelableStatus>> newLoaderInstance(final Context context, final Bundle args) {
        ...
        return new TweetSearchLoader(getActivity(), account_id,
                screen_name.startsWith("@") ? screen_name : "@"
                        + screen_name, max_id, since_id, getData(), getSavedStatusesFileArgs(),
                tab_position);
    }
    ...
    protected String[] getSavedStatusesFileArgs() {
        ...
        final String screen_name = args.getString(INTENT_KEY_SCREEN_NAME);
        return new String[] {
                AUTHORITY_USER_MENTIONS, "account" + account_id, "screen_name" + screen_name
        };
    }
