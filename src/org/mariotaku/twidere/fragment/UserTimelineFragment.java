...
public class UserTimelineFragment extends ParcelableStatusesListFragment {
    ...
    public Loader<List<ParcelableStatus>> newLoaderInstance(final Context context, final Bundle args) {
        ...
        return new UserTimelineLoader(context, account_id, user_id, screen_name, max_id, since_id,
                getData(),
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        final boolean is_my_timeline = user_id > 0 ? account_id == user_id
                : account_id == getAccountId(getActivity(),
                        screen_name);
    ...
    protected String[] getSavedStatusesFileArgs() {
        ...
        final String screen_name = args.getString(INTENT_KEY_SCREEN_NAME);
        return new String[] {
                AUTHORITY_USER_TIMELINE, "account" + account_id,
                "user" + user_id + "name" + screen_name
        };
    }
