...
public class ListSubscribersLoader extends ParcelableUsersLoader {
	...
	public ListSubscribersLoader(Context context, long account_id, int list_id, long user_id, String screen_name, String list_name, long cursor, List<ParcelableUser> users_list) {
