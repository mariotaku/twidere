...
public class ParcelableStatus implements Parcelable, JSONParcelable, Comparable<ParcelableStatus> {
    ...
    public final long retweet_id, retweeted_by_id, id, account_id, user_id, timestamp,
            retweet_count,
            in_reply_to_status_id, my_retweet_id;

    public final boolean is_gap, is_retweet, is_favorite, has_media, is_possibly_sensitive,
            user_is_following,
            user_is_protected, user_is_verified;

    public final String retweeted_by_name, retweeted_by_screen_name, text_html, text_plain,
            user_name,
            user_screen_name, in_reply_to_screen_name, source, user_profile_image_url,
            image_preview_url,
    ...
    public ParcelableStatus(final Cursor cursor, final StatusCursorIndices indices) {
        ...
        retweeted_by_id = indices.retweeted_by_id != -1 ? cursor.getLong(indices.retweeted_by_id)
                : -1;
        ...
        in_reply_to_status_id = indices.in_reply_to_status_id != -1 ? cursor
                .getLong(indices.in_reply_to_status_id)
                : -1;
        ...
        user_is_protected = indices.is_protected != -1 ? cursor.getInt(indices.is_protected) == 1
                : false;
        user_is_verified = indices.is_verified != -1 ? cursor.getInt(indices.is_verified) == 1
                : false;
        retweeted_by_name = indices.retweeted_by_name != -1 ? cursor
                .getString(indices.retweeted_by_name) : null;
        ...
        user_screen_name = indices.user_screen_name != -1 ? cursor
                .getString(indices.user_screen_name) : null;
        ...
        location = indices.location != -1 ? new ParcelableLocation(
                cursor.getString(indices.location)) : null;
        user_profile_image_url = indices.user_profile_image_url != -1 ? cursor
                .getString(indices.user_profile_image_url) : null;
        text_unescaped = indices.text_unescaped != -1 ? cursor.getString(indices.text_unescaped)
                : null;
        my_retweet_id = indices.my_retweet_id != -1 ? cursor.getLong(indices.my_retweet_id) : -1;
        is_possibly_sensitive = indices.is_possibly_sensitive != -1 ? cursor
                .getInt(indices.is_possibly_sensitive) == 1
                : false;
        user_is_following = indices.is_following != -1 ? cursor.getInt(indices.is_following) == 1
                : false;
    }
    ...
    public ParcelableStatus(Status status, final long account_id, final boolean is_gap,
        ...
        final String profile_image_url_orig = user != null ? ParseUtils.parseString(user
    ...
    public String toString() {
        return "ParcelableStatus{retweet_id=" + retweet_id + ", retweeted_by_id=" + retweeted_by_id
                + ", id=" + id
                + ", account_id=" + account_id + ", user_id=" + user_id + ", timestamp="
                + timestamp
                + ", retweet_count=" + retweet_count + ", in_reply_to_status_id="
                + in_reply_to_status_id
                + ", my_retweet_id=" + my_retweet_id + ", is_gap=" + is_gap + ", is_retweet="
                + is_retweet
                + ", is_favorite=" + is_favorite + ", has_media=" + has_media
                + ", is_possibly_sensitive="
                + is_possibly_sensitive + ", user_is_following=" + user_is_following
                + ", user_is_protected="
                + user_is_protected + ", user_is_verified=" + user_is_verified
                + ", retweeted_by_name="
                + retweeted_by_name + ", retweeted_by_screen_name=" + retweeted_by_screen_name
                + ", text_html="
                + text_html + ", text_plain=" + text_plain + ", user_name=" + user_name
                + ", user_screen_name="
                + user_screen_name + ", in_reply_to_screen_name=" + in_reply_to_screen_name
                + ", source=" + source
                + ", user_profile_image_url=" + user_profile_image_url + ", image_preview_url="
                + image_preview_url
                + ", image_original_url=" + image_original_url + ", text_unescaped="
                + text_unescaped + ", location="
                + location + "}";
    }
