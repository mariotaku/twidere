...
public class ParcelableStatusUpdate implements Parcelable {
    ...
    public ParcelableStatusUpdate(final long[] account_ids, final String content,
            final ParcelableLocation location,
            final Uri image_uri, final long in_reply_to_status_id,
    ...
    public String toString() {
        return "ParcelableStatusUpdate{account_ids=" + Arrays.toString(account_ids) + ", content="
                + content
                + ", location=" + location + ", image_uri=" + image_uri
                + ", in_reply_to_status_id="
                + in_reply_to_status_id + ", is_possibly_sensitive=" + is_possibly_sensitive
                + ", delete_image="
                + delete_image + "}";
    }
