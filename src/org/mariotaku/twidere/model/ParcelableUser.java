...
public class ParcelableUser implements Parcelable, JSONParcelable, Comparable<ParcelableUser> {
    ...
    public final String description_plain, name, screen_name, location, profile_image_url,
    ...
    public ParcelableUser(final Cursor cursor, final long account_id) {
        ...
        description_expanded = cursor.getString(cursor
                .getColumnIndex(CachedUsers.DESCRIPTION_EXPANDED));
        ...
        profile_banner_url = cursor
                .getString(cursor.getColumnIndex(CachedUsers.PROFILE_BANNER_URL));
        is_cache = true;
    ...
    public ParcelableUser(final User user, final long account_id, final long position,
        ...
        this.account_id = account_id;
        final String profile_image_url_orig = ParseUtils
        ...
        url_expanded = url != null && urls_url_entities != null && urls_url_entities.length > 0 ? ParseUtils
                .parseString(urls_url_entities[0].getExpandedURL())
                : null;
    ...
    public String toString() {
        return "ParcelableUser{account_id=" + account_id + ", id=" + id + ", created_at="
                + created_at + ", position="
                + position + ", is_protected=" + is_protected + ", is_verified=" + is_verified
                + ", is_follow_request_sent=" + is_follow_request_sent + ", is_following="
                + is_following
                + ", description_plain=" + description_plain + ", name=" + name + ", screen_name="
                + screen_name
                + ", location=" + location + ", profile_image_url=" + profile_image_url
                + ", profile_banner_url="
                + profile_banner_url + ", url=" + url + ", url_expanded=" + url_expanded
                + ", description_html="
                + description_html + ", description_unescaped=" + description_unescaped
                + ", description_expanded="
                + description_expanded + ", followers_count=" + followers_count
                + ", friends_count=" + friends_count
                + ", statuses_count=" + statuses_count + ", favorites_count=" + favorites_count
                + ", is_cache="
                + is_cache + "}";
    }
