...
public class ParcelableUserList implements Parcelable, JSONParcelable,
        Comparable<ParcelableUserList> {
    ...
    public String toString() {
        return "ParcelableUserList{list_id=" + id + ", account_id=" + account_id + ", user_id="
                + user_id
                + ", position=" + position + ", is_public=" + is_public + ", is_following="
                + is_following
                + ", description=" + description + ", name=" + name + ", user_screen_name="
                + user_screen_name
                + ", user_name=" + user_name + ", user_profile_image_url_string="
