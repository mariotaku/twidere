...
public class StatusCursorIndices {
    ...
    public final int _id, account_id, status_id, status_timestamp, user_name, user_screen_name,
            ...
            text_unescaped, user_profile_image_url, is_retweet, is_favorite, is_gap, location,
            is_protected,
            is_verified, in_reply_to_status_id, in_reply_to_screen_name, my_retweet_id,
            retweeted_by_name,
    ...
    public String toString() {
        return "StatusCursorIndices{account_id=" + account_id + ", status_id=" + status_id
                + ", status_timestamp="
                + status_timestamp + ", name=" + user_name + ", screen_name=" + user_screen_name
                + ", text="
                + text_html + ", text_plain=" + text_plain + ", profile_image_url="
                + user_profile_image_url
                + ", is_retweet=" + is_retweet + ", is_favorite=" + is_favorite + ", is_gap="
                + is_gap + ", location="
                ...
                + in_reply_to_screen_name + ", my_retweet_id=" + my_retweet_id
                + ", retweeted_by_name="
                + retweeted_by_name + ", retweeted_by_screen_name=" + retweeted_by_screen_name
                + ", retweet_id="
                + retweet_id + ", retweeted_by_id=" + retweeted_by_id + ", user_id=" + user_id
                + ", source=" + source
                + ", retweet_count=" + retweet_count + ", is_possibly_sensitive="
