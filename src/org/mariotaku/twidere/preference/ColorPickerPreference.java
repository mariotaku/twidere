...
public class ColorPickerPreference extends DialogPreference implements
    ...
    public void onColorChanged(final int color) {
        ...
        dialog.setIcon(new BitmapDrawable(context.getResources(), getColorPreviewBitmap(context,
                color)));
    }
    ...
    protected void init(final Context context, final AttributeSet attrs) {
        if (attrs != null) {
            ...
            if (defaultValue != null && defaultValue.startsWith("#")) {
                ...
                final int colorResourceId = attrs.getAttributeResourceValue(ANDROID_NS,
                        ATTR_DEFAULTVALUE, 0);
    ...
    protected void onPrepareDialogBuilder(final Builder builder) {
        ...
        view.setPadding(Math.round(mColorPicker.getDrawingOffset()), 0,
        ...
        builder.setIcon(new BitmapDrawable(context.getResources(), getColorPreviewBitmap(context,
                val)));
    ...
    private void setPreviewColor() {
        ...
        if (!(widget_frame_view instanceof ViewGroup))
            return;
