...
public class DefaultAPIPreference extends DialogPreference implements Constants, TwitterConstants,
    ...
    public void onClick(final View v) {
        ...
        if (stub_view != null) {
            ...
            mAdvancedAPIConfigLabel.setCompoundDrawablesWithIntrinsicBounds(
                    R.drawable.expander_open_holo, 0, 0, 0);
            ...
            mEditConsumerSecret.setText(isEmpty(mConsumerSecret) ? TWITTER_CONSUMER_SECRET_2
                    : mConsumerSecret);
    ...
    protected void onBindDialogView(final View view) {
        ...
        mConsumerSecret = getNonEmptyString(pref, PREFERENCE_KEY_CONSUMER_SECRET,
                TWITTER_CONSUMER_SECRET_2);
        mRestBaseURL = getNonEmptyString(pref, PREFERENCE_KEY_REST_BASE_URL, DEFAULT_REST_BASE_URL);
        mOAuthBaseURL = getNonEmptyString(pref, PREFERENCE_KEY_OAUTH_BASE_URL,
    ...
    protected void onDialogClosed(final boolean positiveResult) {
        ...
        editor.putString(PREFERENCE_KEY_OAUTH_BASE_URL, isEmpty(mOAuthBaseURL) ? null
                : mOAuthBaseURL);
        editor.putString(PREFERENCE_KEY_SIGNING_REST_BASE_URL, isEmpty(mSigningRestBaseURL) ? null
                : mSigningRestBaseURL);
        editor.putString(PREFERENCE_KEY_SIGNING_OAUTH_BASE_URL,
                isEmpty(mSigningOAuthBaseURL) ? null
                        : mSigningOAuthBaseURL);
