...
public class HomeRefreshContentPreference extends Preference implements Constants, OnPreferenceClickListener,
	...
	public HomeRefreshContentPreference(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.preferenceStyle);
	}

	public HomeRefreshContentPreference(Context context, AttributeSet attrs, int defStyle) {
