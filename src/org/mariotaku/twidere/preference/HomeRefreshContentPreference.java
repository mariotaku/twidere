...
public class HomeRefreshContentPreference extends MultiSelectListPreference implements Constants {
    ...
    protected boolean[] getDefaults() {
        return new boolean[] {
                DEFAULT_ENABLE_MENTIONS, DEFAULT_ENABLE_DIRECT_MESSAGES, DEFAULT_ENABLE_TRENDS
        };
    }
    ...
    protected String[] getKeys() {
        return new String[] {
                PREFERENCE_KEY_HOME_REFRESH_MENTIONS, PREFERENCE_KEY_HOME_REFRESH_DIRECT_MESSAGES,
