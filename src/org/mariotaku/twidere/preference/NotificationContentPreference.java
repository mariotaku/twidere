...
public class NotificationContentPreference extends Preference implements Constants, OnPreferenceClickListener,
	...
	public NotificationContentPreference(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.preferenceStyle);
	}

	public NotificationContentPreference(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onPreferenceClick(Preference preference) {
		...
		checked_items = new boolean[] {
				prefs.getBoolean(PREFERENCE_KEY_NOTIFICATION_ENABLE_HOME_TIMELINE, false),
