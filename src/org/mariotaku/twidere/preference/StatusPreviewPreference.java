...
public class StatusPreviewPreference extends Preference implements Constants,
    ...
    private void setDetailsAndMedia() {
        ...
        mHolder.time.setCompoundDrawablesWithIntrinsicBounds(0, 0,
    ...
    private void setImagePreview() {
        if (mHolder == null)
            return;
        final boolean display = mPreferences
                .getBoolean(PREFERENCE_KEY_DISPLAY_IMAGE_PREVIEW, false);
    ...
    private void setName() {
        final String option = mPreferences.getString(PREFERENCE_KEY_NAME_DISPLAY_OPTION,
    ...
    private void setText() {
        if (mPreferences == null)
            return;
        final boolean underline_only = mPreferences.getBoolean(PREFERENCE_KEY_LINK_UNDERLINE_ONLY,
                false);
        if (underline_only) {
    ...
    private void setTextSize() {
        if (mHolder == null)
            return;
        mHolder.setTextSize(mPreferences.getInt(PREFERENCE_KEY_TEXT_SIZE,
                getDefaultTextSize(getContext())));
    }
