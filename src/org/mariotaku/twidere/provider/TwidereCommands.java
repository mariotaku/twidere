...
public class TwidereCommands {
    ...
    public static class Send {
        ...
        public void updateStatus(final Context context, final long[] account_ids,
                final String content,
                final ParcelableLocation location, final Uri image_uri,
                final long in_reply_to_status_id,
                final boolean is_possibly_sensitive, final boolean delete_image) {
            final ContentValues values = new ContentValues();
            values.put(Constants.INTENT_KEY_ACCOUNT_IDS,
    ...
    private final static class Utils {
        ...
        private static Uri sendInsertCommand(final Context context, final String action,
