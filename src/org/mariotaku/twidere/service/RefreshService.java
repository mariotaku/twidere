...
public class RefreshService extends Service implements Constants {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (BROADCAST_NOTIFICATION_CLEARED.equals(action)) {
                ...
                if (BROADCAST_REFRESH_HOME_TIMELINE.equals(action)) {
                    ...
                    final long[] since_ids = getNewestStatusIdsFromDatabase(context,
                    ...
                    if (mPreferences.getBoolean(PREFERENCE_KEY_REFRESH_ENABLE_TRENDS,
                            AutoRefreshContentPreference.DEFAULT_ENABLE_TRENDS)
                            && !isLocalTrendsRefreshing()) {
                        getLocalTrends();
                    }
                }
            }
    ...
    public void onCreate() {
        ...
        mPendingRefreshMentionsIntent = PendingIntent.getBroadcast(this, 0, new Intent(
                BROADCAST_REFRESH_MENTIONS), 0);
        mPendingRefreshDirectMessagesIntent = PendingIntent.getBroadcast(this, 0, new Intent(
                BROADCAST_REFRESH_DIRECT_MESSAGES), 0);
        mPendingRefreshTrendsIntent = PendingIntent.getBroadcast(this, 0, new Intent(
                BROADCAST_REFRESH_TRENDS), 0);
    ...
    private int getHomeTimeline(final long[] account_ids, final long[] max_ids,
    ...
    private int getReceivedDirectMessages(final long[] account_ids, final long[] max_ids,
            final long[] since_ids) {
