...
import static org.mariotaku.twidere.twitter4j.http.HttpParameter.getParameterArray;
import static org.mariotaku.twidere.twitter4j.internal.util.InternalStringUtil.replaceLast;
...
final class TwitterImpl extends TwitterBaseImpl implements Twitter {
	...
	private void addParameterToList(final List<HttpParameter> params, final String paramName, final Boolean param) {
		if (param != null) {
			params.add(new HttpParameter(paramName, param));
		}
	}

	private void addParameterToList(final List<HttpParameter> params, final String paramName, final Double param) {
		if (param != null) {
			params.add(new HttpParameter(paramName, param));
		}
	}

	private void addParameterToList(final List<HttpParameter> params, final String paramName, final Integer param) {
		if (param != null) {
			params.add(new HttpParameter(paramName, param));
		}
	}

	private void addParameterToList(final List<HttpParameter> params, final String paramName, final String param) {
		if (param != null) {
			params.add(new HttpParameter(paramName, param));
		}
	}
