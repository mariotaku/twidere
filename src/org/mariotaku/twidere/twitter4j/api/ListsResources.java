...
public interface ListsResources {
	 ...
	 * @throws org.mariotaku.twidere.twitter4j.TwitterException when Twitter
	 *             service or network is unavailable, or the authenticated user
	 *             already has 20 lists(TwitterException.getStatusCode() ==
	 *             403).
	 * @see <a
