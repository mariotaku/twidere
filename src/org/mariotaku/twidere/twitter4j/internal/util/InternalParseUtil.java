...
package org.mariotaku.twidere.twitter4j.internal.util;
...
import org.mariotaku.twidere.twitter4j.http.HTMLEntity;
	...
	public static int getInt(final String str) {
		if (null == str || "".equals(str) || "null".equals(str))
			...
			try {
				...
				// http://org.mariotaku.twidere.twitter4j.org/jira/browse/TFJ-484
				return -1;
			}
		}
	}
