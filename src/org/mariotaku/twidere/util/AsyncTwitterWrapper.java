...
public class AsyncTwitterWrapper extends TwitterWrapper {
    ...
    public int addUserListMembers(final long account_id, final int list_id, final long... user_ids) {
        final AddUserListMembersTask task = new AddUserListMembersTask(account_id, list_id,
                user_ids, null);
        return mAsyncTaskManager.add(task, true);
    }

    public int addUserListMembers(final long account_id, final int list_id,
            final String... screen_names) {
        final AddUserListMembersTask task = new AddUserListMembersTask(account_id, list_id, null,
                screen_names);
        return mAsyncTaskManager.add(task, true);
    }

    public void clearNotification(final int id) {
        final Uri uri = Notifications.CONTENT_URI.buildUpon().appendPath(String.valueOf(id))
                .build();
    ...
    public int createUserList(final long account_id, final String list_name,
            final boolean is_public,
            final String description) {
        final CreateUserListTask task = new CreateUserListTask(account_id, list_name, is_public,
                description);
        return mAsyncTaskManager.add(task, true);
    }

    public int createUserListSubscription(final long account_id, final int list_id) {
        final CreateUserListSubscriptionTask task = new CreateUserListSubscriptionTask(account_id,
                list_id);
        return mAsyncTaskManager.add(task, true);
    }

    public int deleteUserListMembers(final long account_id, final int list_id,
            final long... user_ids) {
        final DeleteUserListMembersTask task = new DeleteUserListMembersTask(account_id, list_id,
                user_ids, null);
        return mAsyncTaskManager.add(task, true);
    }
    ...
    public int destroyUserListSubscription(final long account_id, final int list_id) {
        final DestroyUserListSubscriptionTask task = new DestroyUserListSubscriptionTask(
                account_id, list_id);
        return mAsyncTaskManager.add(task, true);
    }
    ...
    public int getReceivedDirectMessages(final long[] account_ids, final long[] max_ids,
        ...
        final GetReceivedDirectMessagesTask task = new GetReceivedDirectMessagesTask(account_ids,
                max_ids, since_ids);
    ...
    public int refreshAll(final long[] account_ids) {
        ...
        if (mPreferences.getBoolean(PREFERENCE_KEY_HOME_REFRESH_DIRECT_MESSAGES,
            ...
            final long[] since_ids = getNewestMessageIdsFromDatabase(mContext,
    ...
    public int sendDirectMessage(final long account_id, final String screen_name,
            final long user_id,
            final String message) {
        final SendDirectMessageTask task = new SendDirectMessageTask(account_id, screen_name,
                user_id, message);
        return mAsyncTaskManager.add(task, true);
    }

    public int updateProfile(final long account_id, final String name, final String url,
            final String location,
            final String description) {
        final UpdateProfileTask task = new UpdateProfileTask(mContext, mAsyncTaskManager,
                account_id, name, url,
                location, description);
        return mAsyncTaskManager.add(task, true);
    }

    public int updateProfileBannerImage(final long account_id, final Uri image_uri,
            final boolean delete_image) {
        final UpdateProfileBannerImageTask task = new UpdateProfileBannerImageTask(mContext,
                mAsyncTaskManager,
                account_id, image_uri, delete_image);
        return mAsyncTaskManager.add(task, true);
    }

    public int updateProfileImage(final long account_id, final Uri image_uri,
            final boolean delete_image) {
        final UpdateProfileImageTask task = new UpdateProfileImageTask(mContext, mAsyncTaskManager,
                account_id,
                image_uri, delete_image);
        return mAsyncTaskManager.add(task, true);
    }

    public int updateStatus(final long[] account_ids, final String content,
        ...
        intent.putExtra(INTENT_KEY_STATUS, new ParcelableStatusUpdate(account_ids, content,
                location, image_uri,
    ...
    public int updateUserListDetails(final long account_id, final int list_id,
            final boolean is_public,
            final String name, final String description) {
        final UpdateUserListDetailsTask task = new UpdateUserListDetailsTask(account_id, list_id,
                is_public, name,
                description);
        return mAsyncTaskManager.add(task, true);
    }

    private Notification buildNotification(final String title, final String message,
            final int icon,
        ...
        if (content_intent != null) {
            content_intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK
        ...
        if (mPreferences.getBoolean(PREFERENCE_KEY_NOTIFICATION_HAVE_SOUND, false)) {
            final Uri def_ringtone = RingtoneManager
                    .getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
            final String path = mPreferences.getString(PREFERENCE_KEY_NOTIFICATION_RINGTONE, "");
            builder.setSound(isEmpty(path) ? def_ringtone : Uri.parse(path),
        ...
        if (mPreferences.getBoolean(PREFERENCE_KEY_NOTIFICATION_HAVE_LIGHTS, false)) {
            ...
            final int color = mPreferences.getInt(PREFERENCE_KEY_NOTIFICATION_LIGHT_COLOR,
                    color_def);
    ...
    public static class UpdateProfileBannerImageTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<Boolean>> {
        ...
        protected SingleResponse<Boolean> doInBackground(final Void... params) {
            return TwitterWrapper.updateProfileBannerImage(mContext, account_id, image_uri,
                    delete_image);
        }
        ...
        protected void onPostExecute(final SingleResponse<Boolean> result) {
            if (result != null && result.data != null && result.data) {
                ...
                Utils.showErrorMessage(mContext, R.string.updating_profile_banner_image,
    ...
    public static class UpdateProfileImageTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<ParcelableUser>> {
        ...
        public UpdateProfileImageTask(final Context context, final AsyncTaskManager manager,
        ...
        protected void onPostExecute(final SingleResponse<ParcelableUser> result) {
            if (result != null && result.data != null) {
                ...
                Utils.showErrorMessage(context, R.string.updating_profile_image, result.exception,
                        true);
            }
    ...
    public static class UpdateProfileTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<ParcelableUser>> {
        ...
        public UpdateProfileTask(final Context context, final AsyncTaskManager manager,
                final long account_id,
        ...
        protected void onPostExecute(final SingleResponse<ParcelableUser> result) {
            if (result != null && result.data != null) {
                ...
                Utils.showErrorMessage(context, context.getString(R.string.updating_profile),
                        result.exception, true);
            }
    ...
    class AddUserListMembersTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<ParcelableUserList>> {
        ...
        public AddUserListMembersTask(final long account_id, final int list_id,
                final long[] user_ids,
                final String[] screen_names) {
        ...
        protected SingleResponse<ParcelableUserList> doInBackground(final Void... params) {
            ...
            if (twitter != null) {
                try {
                    ...
                    if (user_ids != null) {
                        list = new ParcelableUserList(
                                twitter.addUserListMembers(list_id, user_ids), account_id, false);
                    } else if (screen_names != null) {
                        list = new ParcelableUserList(twitter.addUserListMembers(list_id,
                                screen_names), account_id,
                                false);
                    } else
        ...
        protected void onPostExecute(final SingleResponse<ParcelableUserList> result) {
            ...
            if (succeed) {
                final String message = mContext.getString(R.string.added_users_to_list,
                        result.data.name);
        ...
        protected void onPostExecute(final SingleResponse<User> result) {
            if (result != null && result.data != null && result.data.getId() > 0) {
                final String message = mContext.getString(R.string.blocked_user,
                        getUserName(mContext, result.data));
        ...
        protected SingleResponse<ParcelableStatus> doInBackground(final Void... params) {
            ...
            if (twitter != null) {
                try {
                    ...
                    return SingleResponse.dataOnly(new ParcelableStatus(status, account_id, false,
                            mLargeProfileImage));
                } catch (final TwitterException e) {
    ...
    class CreateFriendshipTask extends ManagedAsyncTask<Void, Void, SingleResponse<User>> {
        ...
        protected void onPostExecute(final SingleResponse<User> result) {
            if (result != null && result.data != null) {
                final String message = mContext.getString(R.string.followed_user,
                        getUserName(mContext, result.data));
                mMessagesManager.showOkMessage(message, false);
            } else {
    ...
    class CreateMultiBlockTask extends ManagedAsyncTask<Void, Void, ListResponse<Long>> {
        ...
        private void deleteCaches(final List<Long> list) {
            for (final Uri uri : STATUSES_URIS) {
                bulkDelete(mResolver, uri, Statuses.USER_ID, list, Statuses.ACCOUNT_ID + " = "
                        + account_id, false);
            }
    ...
    class CreateUserListSubscriptionTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<ParcelableUserList>> {
            ...
            if (twitter != null) {
                try {
                    final ParcelableUserList list = new ParcelableUserList(
                            twitter.createUserListSubscription(list_id),
                            account_id, false);
        ...
        protected void onPostExecute(final SingleResponse<ParcelableUserList> result) {
            ...
            if (succeed) {
                final String message = mContext.getString(R.string.subscribed_to_list,
                        result.data.name);
                mMessagesManager.showOkMessage(message, false);
            } else {
                mMessagesManager.showErrorMessage(R.string.subscribing_to_list, result.exception,
                        true);
            }
    ...
    class CreateUserListTask extends ManagedAsyncTask<Void, Void, SingleResponse<UserList>> {
        ...
        public CreateUserListTask(final long account_id, final String list_name,
                final boolean is_public,
                final String description) {
            super(mContext, mAsyncTaskManager);
            this.account_id = account_id;
        ...
        protected SingleResponse<UserList> doInBackground(final Void... params) {
            ...
            if (twitter != null) {
                try {
                    if (list_name != null) {
                        final UserList list = twitter.createUserList(list_name, is_public,
                                description);
                        return SingleResponse.newInstance(list, null);
                    }
                } catch (final TwitterException e) {
        ...
        protected void onPostExecute(final SingleResponse<UserList> result) {
            final boolean succeed = result != null && result.data != null
                    && result.data.getId() > 0;
            if (succeed) {
                final String message = mContext.getString(R.string.created_list,
                        result.data.getName());
                mMessagesManager.showOkMessage(message, false);
            } else {
    ...
    class DeleteUserListMembersTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<ParcelableUserList>> {
        ...
        public DeleteUserListMembersTask(final long account_id, final int list_id,
                final long[] user_ids,
                final String[] screen_names) {
            super(mContext, mAsyncTaskManager);
            this.account_id = account_id;
        ...
        protected SingleResponse<ParcelableUserList> doInBackground(final Void... params) {
            ...
            if (twitter != null) {
                try {
                    final ParcelableUserList list;
                    if (user_ids != null) {
                        list = new ParcelableUserList(twitter.deleteUserListMembers(list_id,
                                user_ids), account_id,
                                false);
                    } else if (screen_names != null) {
                        list = new ParcelableUserList(twitter.deleteUserListMembers(list_id,
        ...
        protected void onPostExecute(final SingleResponse<ParcelableUserList> result) {
            final boolean succeed = result != null && result.data != null && result.data.id > 0;
            if (succeed) {
                final String message = mContext.getString(R.string.deleted_users_from_list,
                        result.data.name);
                mMessagesManager.showInfoMessage(message, false);
            } else {
    ...
    class DestroyDirectMessageTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<DirectMessage>> {
        ...
        protected void onPostExecute(final SingleResponse<DirectMessage> result) {
            ...
            if (result.data != null && result.data.getId() > 0
                    || result.exception instanceof TwitterException
    ...
    class DestroyFavoriteTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<ParcelableStatus>> {
        ...
        protected SingleResponse<ParcelableStatus> doInBackground(final Void... params) {
            ...
            if (twitter != null) {
                try {
                    ...
                    return new SingleResponse<ParcelableStatus>(new ParcelableStatus(status,
                            account_id, false,
            ...
            if (twitter != null) {
                try {
                    ...
                    for (final Uri uri : TweetStore.STATUSES_URIS) {
                        ...
                        mResolver.update(uri, values, Statuses.MY_RETWEET_ID + " = " + status_id,
                                null);
                    }
    ...
    class DestroyUserListSubscriptionTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<ParcelableUserList>> {
        ...
        protected void onPostExecute(final SingleResponse<ParcelableUserList> result) {
            ...
            if (succeed) {
                final String message = mContext.getString(R.string.unsubscribed_from_list,
                        result.data.name);
                mMessagesManager.showOkMessage(message, false);
            } else {
                mMessagesManager.showErrorMessage(R.string.unsubscribing_from_list,
                        result.exception, true);
            }
    ...
    class DestroyUserListTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<ParcelableUserList>> {
        ...
        protected SingleResponse<ParcelableUserList> doInBackground(final Void... params) {
            ...
            if (twitter != null) {
                try {
                    if (list_id > 0) {
                        final ParcelableUserList list = new ParcelableUserList(
                                twitter.destroyUserList(list_id),
                                account_id, false);
                        return new SingleResponse<ParcelableUserList>(list, null);
                    }
                } catch (final TwitterException e) {
    ...
    abstract class GetDirectMessagesTask extends
            ManagedAsyncTask<Void, Void, List<TwitterListResponse<DirectMessage>>> {
            ...
            for (final long account_id : account_ids) {
                ...
                if (twitter != null) {
                    try {
                        ...
                        final ResponseList<DirectMessage> statuses = getDirectMessages(twitter,
                                paging);

                        if (statuses != null) {
                            result.add(new TwitterListResponse<DirectMessage>(account_id, max_id,
                                    since_id,
                                    load_item_limit, statuses, null));
                        }
                    } catch (final TwitterException e) {
                        result.add(new TwitterListResponse<DirectMessage>(account_id, -1, -1,
                                load_item_limit, null, e));
                    }
                }
                idx++;
            }
        ...
        protected void onPostExecute(final List<TwitterListResponse<DirectMessage>> result) {
            ...
            for (final TwitterListResponse<DirectMessage> response : result) {
                if (response.list == null) {
                    mMessagesManager.showErrorMessage(R.string.refreshing_direct_messages,
    ...
    class GetHomeTimelineTask extends GetStatusesTask {
        ...
        public GetHomeTimelineTask(final long[] account_ids, final long[] max_ids,
                final long[] since_ids) {
        ...
        protected void onPostExecute(final List<StatusListResponse> responses) {
            ...
            mAsyncTaskManager.add(new StoreHomeTimelineTask(responses, shouldSetMinId(),
                    !isMaxIdsValid()), true);
            mGetHomeTimelineTaskId = -1;
            for (final StatusListResponse response : responses) {
                if (response.list == null) {
                    mMessagesManager.showErrorMessage(R.string.refreshing_home_timeline,
                            response.exception, true);
                    break;
                }
            }
    ...
    class GetMentionsTask extends GetStatusesTask {
        ...
        public GetMentionsTask(final long[] account_ids, final long[] max_ids,
                final long[] since_ids) {
        ...
        protected void onPostExecute(final List<StatusListResponse> responses) {
            super.onPostExecute(responses);
            mAsyncTaskManager.add(new StoreMentionsTask(responses, shouldSetMinId(),
                    !isMaxIdsValid()), true);
            mGetMentionsTaskId = -1;
            for (final StatusListResponse response : responses) {
                if (response.list == null) {
                    mMessagesManager.showErrorMessage(R.string.refreshing_mentions,
                            response.exception, true);
                    break;
                }
            }
    ...
    class GetReceivedDirectMessagesTask extends GetDirectMessagesTask {
        ...
        @Override
        public ResponseList<DirectMessage> getDirectMessages(final Twitter twitter,
                final Paging paging)
                throws TwitterException {
        ...
        protected void onPostExecute(final List<TwitterListResponse<DirectMessage>> responses) {
            super.onPostExecute(responses);
            mAsyncTaskManager.add(new StoreReceivedDirectMessagesTask(responses, !isMaxIdsValid()),
                    true);
    ...
    class GetSentDirectMessagesTask extends GetDirectMessagesTask {
        ...
        protected void onPostExecute(final List<TwitterListResponse<DirectMessage>> responses) {
            super.onPostExecute(responses);
            mAsyncTaskManager.add(new StoreSentDirectMessagesTask(responses, !isMaxIdsValid()),
                    true);
    ...
    abstract class GetStatusesTask extends ManagedAsyncTask<Void, Void, List<StatusListResponse>> {
        ...
        public GetStatusesTask(final long[] account_ids, final long[] max_ids,
                final long[] since_ids, final String tag) {
            super(mContext, mAsyncTaskManager, tag);
            this.account_ids = account_ids;
            this.max_ids = max_ids;
            this.since_ids = since_ids;
            ...
            for (final long account_id : account_ids) {
                ...
                if (twitter != null) {
                    try {
                        ...
                        if (statuses != null) {
                            result.add(new StatusListResponse(account_id, max_id, since_id,
                                    load_item_limit, statuses,
                                    null));
                        }
                    } catch (final TwitterException e) {
                        result.add(new StatusListResponse(account_id, -1, -1, load_item_limit,
                                null, e));
                    }
                }
                idx++;
    ...
    class ReportSpamTask extends ManagedAsyncTask<Void, Void, SingleResponse<User>> {
        ...
        protected void onPostExecute(final SingleResponse<User> result) {
            if (result != null && result.data != null && result.data.getId() > 0) {
                ...
                mMessagesManager.showErrorMessage(R.string.reporting_for_spam, result.exception,
                        true);
            }
            final Intent intent = new Intent(BROADCAST_BLOCKSTATE_CHANGED);
            intent.putExtra(INTENT_KEY_USER_ID, user_id);
    ...
    class RetweetStatusTask extends ManagedAsyncTask<Void, Void, SingleResponse<twitter4j.Status>> {
        ...
        protected void onPostExecute(final SingleResponse<twitter4j.Status> result) {
            ...
            if (result.data != null && result.data.getId() > 0) {
                ...
                final String where = Statuses.STATUS_ID + " = " + status_id + " OR "
                        + Statuses.RETWEET_ID + " = "
                        + status_id;
                for (final Uri uri : STATUSES_URIS) {
    ...
    class SendDirectMessageTask extends ManagedAsyncTask<Void, Void, SingleResponse<DirectMessage>> {
        ...
        public SendDirectMessageTask(final long account_id, final String screen_name,
                final long user_id,
                final String message) {
            super(mContext, mAsyncTaskManager);
            this.account_id = account_id;
        ...
        protected SingleResponse<DirectMessage> doInBackground(final Void... args) {
            ...
            try {
                if (user_id > 0)
                    return SingleResponse.newInstance(twitter.sendDirectMessage(user_id, message),
                            null);
                else if (screen_name != null)
                    return SingleResponse.newInstance(
        ...
        protected void onPostExecute(final SingleResponse<DirectMessage> result) {
            ...
            if (result.data != null && result.data.getId() > 0) {
                final ContentValues values = makeDirectMessageContentValues(result.data,
                        account_id, true,
                        mLargeProfileImage);
                final String delete_where = DirectMessages.ACCOUNT_ID + " = " + account_id
                        + " AND "
                ...
                mMessagesManager.showErrorMessage(R.string.sending_direct_message,
                        result.exception, true);
            }
        }
    ...
    abstract class StoreDirectMessagesTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<Bundle>> {

        private final List<TwitterListResponse<DirectMessage>> responses;
        private final Uri uri;

        public StoreDirectMessagesTask(final List<TwitterListResponse<DirectMessage>> result,
                final Uri uri,
                final boolean notify, final String tag) {
            super(mContext, mAsyncTaskManager, tag);
            responses = result;
            this.uri = uri.buildUpon()
                    .appendQueryParameter(QUERY_PARAM_NOTIFY, String.valueOf(notify)).build();
        }
                ...
                if (messages != null) {
                    ...
                    // Delete all rows conflicting before new data inserted.
                    {
                        ...
                        where.append(DirectMessages.MESSAGE_ID + " IN ( "
                                ...
                                + " ) ");
                        final Uri delete_uri = appendQueryParameters(uri, new NameValuePairImpl(
                                QUERY_PARAM_NOTIFY,
                                false));
                    ...
                    final Uri insert_uri = appendQueryParameters(uri, new NameValuePairImpl(
                            QUERY_PARAM_NOTIFY, false));
                    mResolver.bulkInsert(insert_uri,
    ...
    class StoreHomeTimelineTask extends StoreStatusesTask {
        ...
        public StoreHomeTimelineTask(final List<StatusListResponse> result,
                final boolean should_set_min_id,
                final boolean notify) {
            super(result, Statuses.CONTENT_URI, should_set_min_id, notify,
                    TASK_TAG_STORE_HOME_TIMELINE);
        }
        ...
        protected void onPostExecute(final SingleResponse<Bundle> response) {
            ...
            if (shouldSetMinId()) {
                final long min_id = response != null && response.data != null ? response.data
                        .getLong(
    ...
    class StoreMentionsTask extends StoreStatusesTask {
        ...
        public StoreMentionsTask(final List<StatusListResponse> result,
                final boolean should_set_min_id,
                final boolean notify) {
    ...
    class StoreReceivedDirectMessagesTask extends StoreDirectMessagesTask {
        ...
        public StoreReceivedDirectMessagesTask(
                final List<TwitterListResponse<DirectMessage>> result,
                final boolean notify) {
            super(result, DirectMessages.Inbox.CONTENT_URI, notify,
                    TASK_TAG_STORE_RECEIVED_DIRECT_MESSAGES);
        }
        ...
        protected void onPostExecute(final SingleResponse<Bundle> response) {
            final boolean succeed = response != null && response.data != null
                    && response.data.getBoolean(INTENT_KEY_SUCCEED);
            mContext.sendBroadcast(new Intent(BROADCAST_RECEIVED_DIRECT_MESSAGES_REFRESHED)
                    .putExtra(
    ...
    class StoreSentDirectMessagesTask extends StoreDirectMessagesTask {
        ...
        public StoreSentDirectMessagesTask(final List<TwitterListResponse<DirectMessage>> result,
            ...
            super(result, DirectMessages.Outbox.CONTENT_URI, notify,
                    TASK_TAG_STORE_SENT_DIRECT_MESSAGES);
        }
        ...
        protected void onPostExecute(final SingleResponse<Bundle> response) {
            final boolean succeed = response != null && response.data != null
                    && response.data.getBoolean(INTENT_KEY_SUCCEED);
            mContext.sendBroadcast(new Intent(BROADCAST_SENT_DIRECT_MESSAGES_REFRESHED).putExtra(
                    INTENT_KEY_SUCCEED,
                    succeed));
            super.onPostExecute(response);
        }
        ...
        protected SingleResponse<Bundle> doInBackground(final Void... args) {
            ...
            for (final StatusListResponse response : responses) {
                ...
                for (final twitter4j.Status status : statuses) {
                    ...
                    final long retweet_id = status.getRetweetedStatus() != null ? status
                ...
                final Uri delete_uri = appendQueryParameters(uri, new NameValuePairImpl(
                        QUERY_PARAM_NOTIFY, false));
                final int rows_deleted = mResolver
                        .delete(delete_uri, delete_where.toString(), null);
                // UCD
                final String UCD_new_status_ids = ListUtils.toString(account_newly_inserted, ',',
                        true);
                ProfilingUtil.profile(mContext, account_id, "Download tweets, "
                        + UCD_new_status_ids);
                all_statuses.addAll(values_list);
                // Insert previously fetched items.
                final Uri insert_query = appendQueryParameters(uri, new NameValuePairImpl(
                        QUERY_PARAM_NEW_ITEMS_COUNT,
                        newly_inserted_ids.size() - rows_deleted), new NameValuePairImpl(
                        QUERY_PARAM_NOTIFY, false));
                mResolver.bulkInsert(insert_query,
                        values_list.toArray(new ContentValues[values_list.size()]));

                // Insert a gap.
                // TODO make sure it will not have bugs.
                final long min_id = status_ids.size() > 0 ? Collections.min(status_ids) : -1;
                final boolean insert_gap = min_id > 0
                        && response.load_item_limit <= response.list.size()
                        && !no_items_before;
                if (insert_gap) {
                    final ContentValues values = new ContentValues();
                    ...
                    final Uri update_uri = appendQueryParameters(uri, new NameValuePairImpl(
                            QUERY_PARAM_NOTIFY, false));
    ...
    class UpdateStatusTask extends
            ManagedAsyncTask<Void, Void, List<SingleResponse<ParcelableStatus>>> {
        ...
        public UpdateStatusTask(final long[] account_ids, final String content,
                final ParcelableLocation location,
                final Uri image_uri, final long in_reply_to, final boolean is_possibly_sensitive,
                final boolean delete_image) {
            super(mContext, mAsyncTaskManager);
            final String uploader_component = mPreferences.getString(PREFERENCE_KEY_IMAGE_UPLOADER,
                    null);
            final String shortener_component = mPreferences.getString(
                    PREFERENCE_KEY_TWEET_SHORTENER, null);
            use_uploader = !isEmpty(uploader_component);
            final TwidereApplication app = TwidereApplication.getInstance(mContext);
            uploader = use_uploader ? ImageUploaderInterface.getInstance(app, uploader_component)
                    : null;
            use_shortener = !isEmpty(shortener_component);
            shortener = use_shortener ? TweetShortenerInterface.getInstance(app,
                    shortener_component) : null;
        ...
        protected List<SingleResponse<ParcelableStatus>> doInBackground(final Void... params) {
            ...
            try {
                ...
                try {
                    ...
                    upload_result_uri = image_file != null && image_file.exists()
                ...
                try {
                    ...
                    shortened_content = should_shorten && use_shortener ? shortener.shorten(
                            unshortened_content,
                ...
                final StatusUpdate status = new StatusUpdate(
                        should_shorten && use_shortener ? shortened_content
                                : unshortened_content);
                    ...
                    try {
                        ...
                        is.setReadListener(new ReadListener() {
                            ...
                            public void onRead(final int length, final int available) {
                                final int percent = length > 0 ? (length - available) * 100
                                        / length : 0;
                ...
                for (final long account_id : account_ids) {
                    ...
                    if (twitter == null) {
                        results.add(new SingleResponse<ParcelableStatus>(null,
                                new NullPointerException()));
                        continue;
                    }
                    try {
                        final ParcelableStatus result = new ParcelableStatus(
                                twitter.updateStatus(status), account_id,
                                false, false);
                        results.add(new SingleResponse<ParcelableStatus>(result, null));
                    } catch (final TwitterException e) {
                        e.printStackTrace();
                        final SingleResponse<ParcelableStatus> response = SingleResponse
                                .exceptionOnly(e);
        ...
        protected void onPostExecute(final List<SingleResponse<ParcelableStatus>> result) {
            ...
            if (result.isEmpty()) {
                ...
                if (exception instanceof TwitterException
                    ...
                    mMessagesManager.showErrorMessage(
                            mContext.getString(R.string.status_is_duplicate), false);
                } else {
                    saveDrafts(failed_account_ids);
        ...
        private void saveDrafts(final List<Long> account_ids) {
            ...
            if (image_uri != null) {
                final int image_type = delete_image ? ATTACHED_IMAGE_TYPE_PHOTO
                        : ATTACHED_IMAGE_TYPE_IMAGE;
            ...
            final Notification notification = buildNotification(title, message,
                    R.drawable.ic_stat_twitter, intent,
                    null);
    ...
    class UpdateUserListDetailsTask extends
            ManagedAsyncTask<Void, Void, SingleResponse<ParcelableUserList>> {
        ...
        public UpdateUserListDetailsTask(final long account_id, final int list_id,
                final boolean is_public,
                final String name, final String description) {
            super(mContext, mAsyncTaskManager);
            this.account_id = account_id;
        ...
        protected SingleResponse<ParcelableUserList> doInBackground(final Void... params) {
            ...
            if (twitter != null) {
                try {
                    final UserList list = twitter.updateUserList(list_id, name, is_public,
                            description);
                    return new SingleResponse<ParcelableUserList>(new ParcelableUserList(list,
        ...
        protected void onPostExecute(final SingleResponse<ParcelableUserList> result) {
            ...
            if (result.data != null && result.data.id > 0) {
                final String message = mContext.getString(R.string.updated_list_details,
                        result.data.name);
                mMessagesManager.showOkMessage(message, false);
                intent.putExtra(INTENT_KEY_SUCCEED, true);
            } else {
                mMessagesManager
                        .showErrorMessage(R.string.updating_details, result.exception, true);
            }
            mContext.sendBroadcast(intent);
            super.onPostExecute(result);
        }
