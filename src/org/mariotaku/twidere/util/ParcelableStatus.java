...
public class ParcelableStatus implements Parcelable {
	...
	public String retweeted_by_name, retweeted_by_screen_name, text, text_plain, name, screen_name,
			in_reply_to_screen_name, source, location;
	...
	public ParcelableStatus(Cursor cursor, StatusesCursorIndices indices) {
		...
		text_plain = Html.fromHtml(text).toString();
		...
		location = cursor.getString(indices.location);
