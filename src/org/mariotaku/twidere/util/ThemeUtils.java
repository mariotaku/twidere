...
public class ThemeUtils implements Constants {
    ...
    static {
        ...
        THEMES_SWIPEBACK.put(THEME_NAME_LIGHT_DARKACTIONBAR,
                R.style.Theme_Twidere_Light_DarkActionBar_SwipeBack);
        ...
        THEMES_SOLIDBG.put(THEME_NAME_LIGHT_DARKACTIONBAR,
                R.style.Theme_Twidere_Light_DarkActionBar_SolidBackground);
        THEMES_SWIPEBACK_SOLIDBG.put(THEME_NAME_TWIDERE,
                R.style.Theme_Twidere_SwipeBack_SolidBackground);
        THEMES_SWIPEBACK_SOLIDBG.put(THEME_NAME_DARK,
                R.style.Theme_Twidere_Dark_SwipeBack_SolidBackground);
        THEMES_SWIPEBACK_SOLIDBG.put(THEME_NAME_LIGHT,
                R.style.Theme_Twidere_Light_SwipeBack_SolidBackground);
        ...
        THEMES_COMPOSE.put(THEME_NAME_LIGHT_DARKACTIONBAR,
                R.style.Theme_Twidere_Light_DarkActionBar_Compose);
    }
    ...
    public static int getCardListBackgroundColor(final Context context) {
        final TypedArray a = context.obtainStyledAttributes(new int[] {
            R.attr.cardListBackgroundColor
        });
    ...
    public static Drawable getListMenuOverflowButtonDrawable(final Context context) {
        final TypedArray a = context.obtainStyledAttributes(new int[] {
            R.attr.listMenuOverflowButton
        });
        final Drawable d = a.getDrawable(0);
        a.recycle();
        if (d == null)
            return context.getResources().getDrawable(
                    R.drawable.ic_list_menu_moreoverflow_normal_holo_light);
        return d;
    }
    ...
    public static int getSwipeBackThemeResource(final String name, final boolean solid_background) {
        final Integer res = (solid_background ? THEMES_SWIPEBACK_SOLIDBG : THEMES_SWIPEBACK)
                .get(name);
    ...
    public static String getThemeName(final Context context) {
        ...
        return pref != null ? pref.getString(PREFERENCE_KEY_THEME, THEME_NAME_TWIDERE)
                : THEME_NAME_TWIDERE;
    }
