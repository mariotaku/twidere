...
public class TwitterWrapper implements Constants {
    ...
    public static SingleResponse<ParcelableUser> updateProfile(final Context context,
            final long account_id,
    ...
    public static SingleResponse<Boolean> updateProfileBannerImage(final Context context,
            final long account_id,
    ...
    public static SingleResponse<ParcelableUser> updateProfileImage(final Context context,
            final long account_id,
            final Uri image_uri, final boolean delete_image) {
        final Twitter twitter = getTwitterInstance(context, account_id, false);
        final boolean large_profile_image = context.getResources().getBoolean(
