...
public class ColorLabelFrameLayout extends FrameLayout implements IColorLabelView {
    ...
    private final Paint mPaintStart = new Paint(), mPaintEnd = new Paint(),
            mPaintBackground = new Paint();
    private final Rect mRectStart = new Rect(), mRectEnd = new Rect(),
    ...
    protected void onSizeChanged(final int w, final int h, final int oldw, final int oldh) {
        ...
        (mIsRTL ? mRectStart : mRectEnd).set(w - (int) (LABEL_WIDTH * mDensity) - pr, pt, w - pr, h
                - pb);
