...
public class ProfileImageBannerLayout extends ExtendedFrameLayout {
    ...
    public ProfileImageBannerLayout(final Context context, final AttributeSet attrs,
        ...
        addView(mProfileImageView, new LayoutParams(LayoutParams.WRAP_CONTENT,
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if (width > 0) {
            ...
            final LayoutParams profile_lp = (FrameLayout.LayoutParams) mProfileImageView
                    .getLayoutParams();
    ...
    private static class ProfileImageView extends ClickableImageView {
        ...
        protected void onDraw(final Canvas canvas) {
            ...
            if (width > 0 && height > 0) {
                canvas.drawRect(mPaddings, mPaddings, width - mPaddings, height - mPaddings,
                        mBlackPaint);
                canvas.drawRect(mPaddings / 2, mPaddings / 2, width - mPaddings / 2, height
                        - mPaddings / 2,
                        mWhitePaint);
            }
            super.onDraw(canvas);
