...
public class AccountDrawerGroupViewHolder {
    ...
    public AccountDrawerGroupViewHolder(final View view) {
        ...
        profile_image_banner = (ProfileImageBannerLayout) view
                .findViewById(R.id.profile_image_banner);
        profile_image = (ImageView) profile_image_banner
                .findViewById(ProfileImageBannerLayout.VIEW_ID_PROFILE_IMAGE);
        profile_banner = (ImageView) profile_image_banner
                .findViewById(ProfileImageBannerLayout.VIEW_ID_PROFILE_BANNER);
