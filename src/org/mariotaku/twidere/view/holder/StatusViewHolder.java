...
public class StatusViewHolder implements Constants {
    ...
    public void setReplyTo(final String in_reply_to_screen_name) {
        ...
        reply_retweet_status.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_indicator_reply,
                0, 0, 0);
    }
    ...
    public void setRetweetedBy(final long retweet_count, final String retweeted_by_name,
        ...
        if (name_display_option == NAME_DISPLAY_OPTION_CODE_SCREEN_NAME) {
            reply_retweet_status.setText(retweet_count > 1 ? res.getString(
                    R.string.retweeted_by_with_count,
                    retweeted_by_screen_name, retweet_count - 1) : res.getString(
                    R.string.retweeted_by,
                    retweeted_by_screen_name));
        } else {
            reply_retweet_status.setText(retweet_count > 1 ? res.getString(
                    R.string.retweeted_by_with_count,
                    retweeted_by_name, retweet_count - 1) : res.getString(R.string.retweeted_by,
                    retweeted_by_name));
        }
        reply_retweet_status.setCompoundDrawablesWithIntrinsicBounds(
                R.drawable.ic_indicator_retweet, 0, 0, 0);
    }
    ...
    public void setStatusType(final boolean is_favorite, final boolean has_location,
            final boolean has_media,
