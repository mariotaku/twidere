...
public final class OEmbedRequest implements Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (hideMedia != that.hideMedia)
            return false;
        if (hideThread != that.hideThread)
            return false;
        if (maxWidth != that.maxWidth)
            return false;
        if (omitScript != that.omitScript)
            return false;
        ...
        if (lang != null ? !lang.equals(that.lang) : that.lang != null)
            return false;
        if (!Arrays.equals(related, that.related))
            return false;
    ...
    public String toString() {
        return "OEmbedRequest{" + "statusId=" + statusId + ", url='" + url + '\'' + ", maxWidth="
                + maxWidth
                + ", hideMedia=" + hideMedia + ", hideThread=" + hideThread + ", omitScript="
                + omitScript + ", align="
                + align + ", related=" + (related == null ? null : Arrays.asList(related))
                + ", lang='" + lang + '\''
                + '}';
    }

    private void appendParameter(final String name, final long value,
