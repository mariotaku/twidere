...
public final class Paging {
    ...
    public String toString() {
        return "Paging{" + "page=" + page + ", count=" + count + ", sinceId=" + sinceId
                + ", maxId=" + maxId + '}';
    }
     ...
     */
    /* package */HttpParameter[] asPostParameterArray(final char[] supportedParams,
            final String perPageParamName) {
        final java.util.List<HttpParameter> pagingParams = new ArrayList<HttpParameter>(
