...
final class TwitterImpl extends TwitterBaseImpl implements Twitter {
    ...
    public UserList addUserListMember(final int listId, final long userId) throws TwitterException {
        ...
        return factory.createAUserList(post(conf.getRestBaseURL() + ENDPOINT_LISTS_MEMBERS_CREATE,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_MEMBERS_CREATE, new HttpParameter(
                        "list_id", listId),
                new HttpParameter("list_id", listId)));
    }

    @Override
    public UserList addUserListMember(final int listId, final String screenName)
    ...
    public UserList addUserListMembers(final int listId, final long[] userIds)
        ...
        return factory.createAUserList(post(conf.getRestBaseURL()
                + ENDPOINT_LISTS_MEMBERS_CREATE_ALL,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_MEMBERS_CREATE_ALL,
                new HttpParameter("list_id", listId),
    ...
    public User createBlock(final long userId) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createUser(post(conf.getRestBaseURL() + ENDPOINT_BLOCKS_CREATE,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_BLOCKS_CREATE, new HttpParameter("user_id", userId),
                INCLUDE_ENTITIES));
    }
    ...
    public User createBlock(final String screenName) throws TwitterException {
        ...
        return factory.createUser(post(conf.getRestBaseURL() + ENDPOINT_BLOCKS_CREATE,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_BLOCKS_CREATE, new HttpParameter("screen_name", screenName),
                INCLUDE_ENTITIES));
    }
    ...
    public Status createFavorite(final long id) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory
                .createStatus(post(conf.getRestBaseURL() + ENDPOINT_FAVORITES_CREATE,
                        conf.getSigningRestBaseURL()
                                + ENDPOINT_FAVORITES_CREATE, new HttpParameter("id", id),
                        INCLUDE_ENTITIES));
    }
    ...
    public User createFriendship(final long userId) throws TwitterException {
        ...
        return factory.createUser(post(conf.getRestBaseURL() + ENDPOINT_FRIENDSHIPS_CREATE,
                conf.getSigningRestBaseURL() + ENDPOINT_FRIENDSHIPS_CREATE, new HttpParameter(
                        "user_id", userId)));
    }
    ...
    public Place createPlace(final String name, final String containedWithin, final String token,
        ...
        return factory.createPlace(post(conf.getRestBaseURL() + ENDPOINT_GEO_PLACE,
                conf.getSigningRestBaseURL()
    ...
    public SavedSearch createSavedSearch(final String query) throws TwitterException {
        ...
        return factory.createSavedSearch(post(conf.getRestBaseURL()
                + ENDPOINT_SAVED_SEARCHES_CREATE,
                conf.getSigningRestBaseURL() + ENDPOINT_SAVED_SEARCHES_CREATE, new HttpParameter(
                        "query", query)));
    }
    ...
    public UserList createUserList(final String listName, final boolean isPublicList,
        ...
        return factory.createAUserList(post(conf.getRestBaseURL() + ENDPOINT_LISTS_CREATE,
                conf.getSigningRestBaseURL()
    ...
    public UserList createUserListSubscription(final int listId) throws TwitterException {
        ...
        return factory
                .createAUserList(post(conf.getRestBaseURL() + ENDPOINT_LISTS_SUBSCRIBERS_CREATE,
                        conf.getSigningRestBaseURL() + ENDPOINT_LISTS_SUBSCRIBERS_CREATE,
                        new HttpParameter("list_id",
                                listId)));
    }
    ...
    public UserList deleteUserListMember(final int listId, final long userId)
        ...
        return factory.createAUserList(post(conf.getRestBaseURL() + ENDPOINT_LISTS_MEMBERS_DESTROY,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_MEMBERS_DESTROY, new HttpParameter(
                        "list_id", listId),
                new HttpParameter("user_id", userId)));
    }

    @Override
    public UserList deleteUserListMember(final int listId, final String screenName)
            throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createAUserList(post(conf.getRestBaseURL() + ENDPOINT_LISTS_MEMBERS_DESTROY,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_MEMBERS_DESTROY, new HttpParameter(
    ...
    @Override
    public UserList deleteUserListMembers(final int listId, final long[] userIds)
            throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createAUserList(post(conf.getRestBaseURL()
                + ENDPOINT_LISTS_MEMBERS_DESTROY_ALL,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_MEMBERS_DESTROY_ALL,
                new HttpParameter("list_id", listId), new HttpParameter("user_id",
                        InternalStringUtil.join(userIds))));
    }

    @Override
    public UserList deleteUserListMembers(final int listId, final String[] screenNames)
            throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createAUserList(post(conf.getRestBaseURL()
                + ENDPOINT_LISTS_MEMBERS_DESTROY_ALL,
    ...
    public User destroyBlock(final long userId) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createUser(post(conf.getRestBaseURL() + ENDPOINT_BLOCKS_DESTROY,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_BLOCKS_DESTROY, new HttpParameter("user_id", userId),
                INCLUDE_ENTITIES));
    }
    ...
    public User destroyBlock(final String screenName) throws TwitterException {
        ...
        return factory.createUser(post(conf.getRestBaseURL() + ENDPOINT_BLOCKS_DESTROY,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_BLOCKS_DESTROY, new HttpParameter("screen_name", screenName),
                INCLUDE_ENTITIES));
    }
    ...
    public DirectMessage destroyDirectMessage(final long id) throws TwitterException {
        ...
        return factory.createDirectMessage(post(conf.getRestBaseURL()
                ...
                conf.getSigningRestBaseURL() + ENDPOINT_DIRECT_MESSAGES_DESTROY, new HttpParameter(
                        "id", id),
                INCLUDE_ENTITIES));
    }
    ...
    public Status destroyFavorite(final long id) throws TwitterException {
        ...
        return factory.createStatus(post(conf.getRestBaseURL() + ENDPOINT_FAVORITES_DESTROY,
                conf.getSigningRestBaseURL() + ENDPOINT_FAVORITES_DESTROY, new HttpParameter("id",
                        id),
                INCLUDE_ENTITIES));
    }
    ...
    public User destroyFriendship(final long userId) throws TwitterException {
        ...
        return factory.createUser(post(conf.getRestBaseURL() + ENDPOINT_FRIENDSHIPS_DESTROY,
                conf.getSigningRestBaseURL() + ENDPOINT_FRIENDSHIPS_DESTROY, new HttpParameter(
                        "user_id", userId)));
    }
    ...
    public SavedSearch destroySavedSearch(final int id) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createSavedSearch(post(conf.getRestBaseURL() + "saved_searches/destroy/"
                + id + ".json",
    ...
    public Status destroyStatus(final long statusId) throws TwitterException {
        ...
        return factory.createStatus(post(conf.getRestBaseURL() + "statuses/destroy/" + statusId
                + ".json",
                conf.getSigningRestBaseURL() + "statuses/destroy/" + statusId + ".json",
                INCLUDE_ENTITIES));
    }
    ...
    public UserList destroyUserList(final int listId) throws TwitterException {
        ...
        return factory.createAUserList(post(conf.getRestBaseURL() + ENDPOINT_LISTS_DESTROY,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_DESTROY, new HttpParameter("list_id",
                        listId)));
    }
    ...
    public UserList destroyUserListSubscription(final int listId) throws TwitterException {
        ...
        return factory
                .createAUserList(post(conf.getRestBaseURL() + ENDPOINT_LISTS_SUBSCRIBERS_DESTROY,
                        conf.getSigningRestBaseURL() + ENDPOINT_LISTS_SUBSCRIBERS_DESTROY,
                        new HttpParameter("list_id",
                                listId)));
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!INCLUDE_ENTITIES.equals(twitter.INCLUDE_ENTITIES))
            return false;
        if (!INCLUDE_RTS.equals(twitter.INCLUDE_RTS))
            return false;
    ...
    public ResponseList<Activity> getActivitiesAboutMe(final Paging paging) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createActivityList(get(
                conf.getRestBaseURL() + ENDPOINT_ACTIVITY_ABOUT_ME,
                conf.getSigningRestBaseURL() + ENDPOINT_ACTIVITY_ABOUT_ME,
                mergeParameters(paging != null ? paging.asPostParameterArray() : null,
                        INCLUDE_ENTITIES)));
    }
    ...
    @Override
    public ResponseList<Activity> getActivitiesByFriends(final Paging paging)
            throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createActivityList(get(
                conf.getRestBaseURL() + ENDPOINT_ACTIVITY_BY_FRIENDS,
    ...
    public TwitterAPIConfiguration getAPIConfiguration() throws TwitterException {
        return factory.createTwitterAPIConfiguration(get(conf.getRestBaseURL()
    ...
    public ResponseList<Location> getAvailableTrends(final GeoLocation location)
        ...
        return factory.createLocationList(get(conf.getRestBaseURL() + ENDPOINT_TRENDS_AVAILABLE,
                conf.getSigningRestBaseURL() + ENDPOINT_TRENDS_AVAILABLE,
                new HttpParameter("lat", location.getLatitude()), new HttpParameter("long",
    ...
    public IDs getBlocksIDs() throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createIDs(get(conf.getRestBaseURL() + ENDPOINT_BLOCKS_IDS,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_BLOCKS_IDS));
    }
    ...
    @Override
    public PagableResponseList<User> getBlocksList(final CursorPaging paging)
            throws TwitterException {
        ensureAuthorizationEnabled();
        return factory
                .createPagableUserList(get(conf.getRestBaseURL() + ENDPOINT_BLOCKS_LIST,
                        conf.getSigningRestBaseURL() + ENDPOINT_BLOCKS_LIST,
    ...
    public ResponseList<DirectMessage> getDirectMessages(final Paging paging)
            throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createDirectMessageList(get(
                conf.getRestBaseURL() + ENDPOINT_DIRECT_MESSAGES,
    ...
    public ResponseList<Status> getFavorites(final long userId) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createStatusList(get(conf.getRestBaseURL() + ENDPOINT_FAVORITES_LIST,
                conf.getSigningRestBaseURL() + ENDPOINT_FAVORITES_LIST, new HttpParameter(
                        "user_id", userId),
                INCLUDE_ENTITIES));
    }
    ...
    public ResponseList<Status> getFavorites(final long userId, final Paging paging)
        ...
        return factory
                .createStatusList(get(
                        ...
                        mergeParameters(paging.asPostParameterArray(), new HttpParameter("user_id",
                                userId),
                                INCLUDE_ENTITIES)));
    }
    ...
    public ResponseList<Status> getFavorites(final String screenName, final Paging paging)
        ...
        return factory.createStatusList(get(
                conf.getRestBaseURL() + ENDPOINT_FAVORITES_LIST,
                conf.getSigningRestBaseURL() + ENDPOINT_FAVORITES_LIST,
                mergeParameters(paging.asPostParameterArray(), new HttpParameter("screen_name",
                        screenName),
                        INCLUDE_ENTITIES)));
    }
    ...
    public IDs getFollowersIDs(final CursorPaging paging) throws TwitterException {
        return factory.createIDs(get(conf.getRestBaseURL() + ENDPOINT_FOLLOWERS_IDS,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_FOLLOWERS_IDS, paging.asPostParameterArray()));
    }

    @Override
    public IDs getFollowersIDs(final long userId, final CursorPaging paging)
            throws TwitterException {
        return factory
                .createIDs(get(
                        conf.getRestBaseURL() + ENDPOINT_FOLLOWERS_IDS,
                        conf.getSigningRestBaseURL()
    ...
    @Override
    public IDs getFollowersIDs(final String screenName, final CursorPaging paging)
            throws TwitterException {
    ...
    @Override
    public PagableResponseList<User> getFollowersList(final CursorPaging paging)
            throws TwitterException {
    ...
    public PagableResponseList<User> getFollowersList(final long userId, final CursorPaging paging)
        ...
        return factory
                .createPagableUserList(get(
                        conf.getRestBaseURL() + ENDPOINT_FOLLOWERS_LIST,
                        conf.getSigningRestBaseURL() + ENDPOINT_FOLLOWERS_LIST,
                        mergeParameters(paging.asPostParameterArray(), new HttpParameter("user_id",
                                userId))));
    }
    ...
    public IDs getFriendsIDs(final CursorPaging paging) throws TwitterException {
        return factory.createIDs(get(conf.getRestBaseURL() + ENDPOINT_FRIENDS_IDS,
                conf.getSigningRestBaseURL()
    ...
    public IDs getFriendsIDs(final long userId, final CursorPaging paging) throws TwitterException {
        return factory
                .createIDs(get(
                        conf.getRestBaseURL() + ENDPOINT_FRIENDS_IDS,
                        conf.getSigningRestBaseURL()
    ...
    @Override
    public IDs getFriendsIDs(final String screenName, final CursorPaging paging)
            throws TwitterException {
        return factory.createIDs(get(
                conf.getRestBaseURL() + ENDPOINT_FRIENDS_IDS,
                conf.getSigningRestBaseURL()
    ...
    @Override
    public PagableResponseList<User> getFriendsList(final CursorPaging paging)
            throws TwitterException {
        return factory
                .createPagableUserList(get(conf.getRestBaseURL() + ENDPOINT_FRIENDS_LIST,
    ...
    public PagableResponseList<User> getFriendsList(final long userId, final CursorPaging paging)
        ...
        return factory
                .createPagableUserList(get(
                        conf.getRestBaseURL() + ENDPOINT_FRIENDS_LIST,
                        conf.getSigningRestBaseURL() + ENDPOINT_FRIENDS_LIST,
                        mergeParameters(paging.asPostParameterArray(), new HttpParameter("user_id",
                                userId))));
    }
    ...
    public ResponseList<Status> getHomeTimeline() throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createStatusList(get(
                conf.getRestBaseURL() + ENDPOINT_STATUSES_HOME_TIMELINE,
                conf.getSigningRestBaseURL() + ENDPOINT_STATUSES_HOME_TIMELINE, INCLUDE_MY_RETWEET,
                INCLUDE_ENTITIES));
    }
    ...
    public IDs getIncomingFriendships(final CursorPaging paging) throws TwitterException {
        ...
        return factory.createIDs(get(conf.getRestBaseURL() + ENDPOINT_FRIENDSHIPS_INCOMING,
                conf.getSigningRestBaseURL() + ENDPOINT_FRIENDSHIPS_INCOMING,
                paging.asPostParameterArray()));
    }
    ...
    public ResponseList<User> getMemberSuggestions(final String categorySlug)
            throws TwitterException {
        final HttpResponse res = get(conf.getRestBaseURL() + "users/suggestions/" + categorySlug
                + "/members.json",
                conf.getSigningRestBaseURL() + "users/suggestions/" + categorySlug
                        + "/members.json");
    ...
    public OEmbed getOEmbed(final OEmbedRequest req) throws TwitterException {
        return factory.createOEmbed(get(conf.getRestBaseURL() + ENDPOINT_STATUSES_OEMBED,
                conf.getRestBaseURL()
    ...
    public IDs getOutgoingFriendships(final CursorPaging paging) throws TwitterException {
        ...
        return factory.createIDs(get(conf.getRestBaseURL() + ENDPOINT_FRIENDSHIPS_OUTGOING,
                conf.getSigningRestBaseURL() + ENDPOINT_FRIENDSHIPS_OUTGOING,
                paging.asPostParameterArray()));
    }

    @Override
    public Trends getPlaceTrends(final int woeid) throws TwitterException {
        return factory.createTrends(get(conf.getRestBaseURL() + ENDPOINT_TRENDS_PLACE,
                conf.getSigningRestBaseURL()
    ...
    public String getPrivacyPolicy() throws TwitterException {
        try {
            return get(conf.getRestBaseURL() + ENDPOINT_LEGAL_PRIVACY,
                    conf.getSigningRestBaseURL() + ENDPOINT_LEGAL_PRIVACY).asJSONObject()
                    .getString("privacy");
    ...
    public Map<String, RateLimitStatus> getRateLimitStatus() throws TwitterException {
        return factory.createRateLimitStatus(get(
                conf.getRestBaseURL() + ENDPOINT_RATE_LIMIT_STATUS,
    ...
    public Map<String, RateLimitStatus> getRateLimitStatus(final String... resources)
        ...
        return factory.createRateLimitStatus(get(
                conf.getRestBaseURL() + ENDPOINT_RATE_LIMIT_STATUS,
                conf.getSigningRestBaseURL() + ENDPOINT_RATE_LIMIT_STATUS, new HttpParameter(
                        "resources",
    ...
    public IDs getRetweetersIDs(final long statusId) throws TwitterException {
        ...
        return factory.createIDs(get(conf.getRestBaseURL() + ENDPOINT_STATUSES_RETWEETERS_IDS,
                conf.getSigningRestBaseURL() + ENDPOINT_STATUSES_RETWEETERS_IDS, new HttpParameter(
                        "id", statusId)));
    }

    @Override
    public IDs getRetweetersIDs(final long statusId, final CursorPaging paging)
            throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createIDs(get(conf.getRestBaseURL() + ENDPOINT_STATUSES_RETWEETERS_IDS,
    ...
    public ResponseList<Status> getRetweets(final long statusId) throws TwitterException {
        ...
        return factory.createStatusList(get(conf.getRestBaseURL() + "statuses/retweets/" + statusId
                + ".json",
                conf.getSigningRestBaseURL() + "statuses/retweets/" + statusId + ".json",
                INCLUDE_ENTITIES));
    }

    @Override
    public ResponseList<Status> getRetweets(final long statusId, final int count)
            throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createStatusList(get(conf.getRestBaseURL() + "statuses/retweets/" + statusId
                + ".json",
    ...
    public ResponseList<Status> getRetweetsOfMe() throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createStatusList(get(conf.getRestBaseURL()
                + ENDPOINT_STATUSES_RETWEETS_OF_ME,
                conf.getSigningRestBaseURL() + ENDPOINT_STATUSES_RETWEETS_OF_ME, INCLUDE_ENTITIES,
                INCLUDE_RTS));
    }
    ...
    public ResponseList<SavedSearch> getSavedSearches() throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createSavedSearchList(get(conf.getRestBaseURL()
    ...
    public String getTermsOfService() throws TwitterException {
        try {
            return get(conf.getRestBaseURL() + ENDPOINT_LEGAL_TOS,
                    conf.getSigningRestBaseURL() + ENDPOINT_LEGAL_TOS)
    ...
    public PagableResponseList<User> getUserListMembers(final int listId, final CursorPaging paging)
        ...
        return factory
                .createPagableUserList(get(
                        ...
                        mergeParameters(paging.asPostParameterArray(), new HttpParameter("list_id",
                                listId),
                                INCLUDE_ENTITIES)));
    }

    @Override
    public PagableResponseList<User> getUserListMembers(final String slug, final long ownerId,
            final CursorPaging paging)
            throws TwitterException {
        return factory.createPagableUserList(get(
                conf.getRestBaseURL() + ENDPOINT_LISTS_MEMBERS,
    ...
    @Override
    public PagableResponseList<User> getUserListMembers(final String slug,
    ...
    public PagableResponseList<UserList> getUserListMemberships(final long cursor)
        ...
        return factory.createPagableUserListList(get(conf.getRestBaseURL()
                + ENDPOINT_LISTS_MEMBERSHIPS,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_MEMBERSHIPS, new HttpParameter(
                        "cursor", cursor)));
    ...
    public PagableResponseList<UserList> getUserListMemberships(final long listMemberId,
        ...
        return factory.createPagableUserListList(get(conf.getRestBaseURL()
                + ENDPOINT_LISTS_MEMBERSHIPS,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_MEMBERSHIPS, new HttpParameter(
                        "user_id", listMemberId),
                new HttpParameter("cursor", cursor), new HttpParameter("filter_to_owned_lists",
                        filterToOwnedLists)));
    }
    ...
    public ResponseList<UserList> getUserLists(final long listOwnerUserId) throws TwitterException {
        return factory.createUserListList(get(conf.getRestBaseURL() + ENDPOINT_LISTS_LIST,
                conf.getSigningRestBaseURL()
    ...
    @Override
    public ResponseList<Status> getUserListStatuses(final String slug, final long ownerId,
            final Paging paging)
            throws TwitterException {
        return factory.createStatusList(get(
                conf.getRestBaseURL() + ENDPOINT_LISTS_STATUSES,
    ...
    @Override
    public ResponseList<Status> getUserListStatuses(final String slug,
            final String ownerScreenName, final Paging paging)
            throws TwitterException {
        return factory.createStatusList(get(
                conf.getRestBaseURL() + ENDPOINT_LISTS_STATUSES,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_STATUSES,
    ...
    @Override
    public PagableResponseList<User> getUserListSubscribers(final int listId,
            final CursorPaging paging)
            throws TwitterException {
        return factory
                .createPagableUserList(get(
    ...
    @Override
    public PagableResponseList<User> getUserListSubscribers(final String slug,
            final String ownerScreenName,
            final CursorPaging paging) throws TwitterException {
        return factory.createPagableUserList(get(
                conf.getRestBaseURL() + ENDPOINT_LISTS_SUBSCRIBERS,
    ...
    public PagableResponseList<UserList> getUserListSubscriptions(final String listOwnerScreenName,
            ...
            throws TwitterException {
        return factory.createPagableUserListList(get(conf.getRestBaseURL()
                + ENDPOINT_LISTS_SUBSCRIPTIONS,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_SUBSCRIPTIONS, new HttpParameter(
                        "screen_name",
    ...
    public ResponseList<Status> getUserTimeline(final Paging paging) throws TwitterException {
        ...
        return factory.createStatusList(get(
                conf.getRestBaseURL() + ENDPOINT_STATUSES_USER_TIMELINE,
                conf.getSigningRestBaseURL() + ENDPOINT_STATUSES_USER_TIMELINE,
                mergeParameters(paging != null ? paging.asPostParameterArray() : null, INCLUDE_RTS,
                        INCLUDE_ENTITIES,
                        INCLUDE_MY_RETWEET)));
    }
    ...
    public ResponseList<Friendship> lookupFriendships(final long[] ids) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createFriendshipList(get(
                conf.getRestBaseURL() + ENDPOINT_FRIENDSHIPS_LOOKUP,
                conf.getSigningRestBaseURL() + ENDPOINT_FRIENDSHIPS_LOOKUP, new HttpParameter(
                        "user_id",
    ...
    public ResponseList<User> lookupUsers(final long[] ids) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createUserList(get(conf.getRestBaseURL() + ENDPOINT_USERS_LOOKUP,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_USERS_LOOKUP,
                new HttpParameter("user_id", InternalStringUtil.join(ids)), INCLUDE_ENTITIES));
    }
    ...
    public ResponseList<User> lookupUsers(final String[] screenNames) throws TwitterException {
        ...
        return factory.createUserList(get(conf.getRestBaseURL() + ENDPOINT_USERS_LOOKUP,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_USERS_LOOKUP, new HttpParameter("screen_name",
                        InternalStringUtil.join(screenNames)),
                INCLUDE_ENTITIES));
    }
    ...
    public void removeProfileBannerImage() throws TwitterException {
        ensureAuthorizationEnabled();
        post(conf.getRestBaseURL() + ENDPOINT_ACCOUNT_REMOVE_PROFILE_BANNER,
                conf.getSigningRestBaseURL()
    ...
    public User reportSpam(final long userId) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createUser(post(conf.getRestBaseURL() + ENDPOINT_USERS_REPORT_SPAM,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_USERS_REPORT_SPAM, new HttpParameter("user_id", userId),
                INCLUDE_ENTITIES));
    }
    ...
    public User reportSpam(final String screenName) throws TwitterException {
        ...
        return factory.createUser(post(conf.getRestBaseURL() + ENDPOINT_USERS_REPORT_SPAM,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_USERS_REPORT_SPAM, new HttpParameter("screen_name", screenName),
                INCLUDE_ENTITIES));
    }
    ...
    public Status retweetStatus(final long statusId) throws TwitterException {
        ...
        return factory.createStatus(post(conf.getRestBaseURL() + "statuses/retweet/" + statusId
                + ".json",
                conf.getSigningRestBaseURL() + "statuses/retweet/" + statusId + ".json",
                INCLUDE_ENTITIES));
    }
    ...
    public ResponseList<Place> reverseGeoCode(final GeoQuery query) throws TwitterException {
        try {
            return factory.createPlaceList(get(
                    conf.getRestBaseURL() + ENDPOINT_GEO_REVERSE_GEOCODE,
                    conf.getSigningRestBaseURL() + ENDPOINT_GEO_REVERSE_GEOCODE,
    ...
    public QueryResult search(final Query query) throws TwitterException {
        return factory.createQueryResult(
                get(conf.getRestBaseURL() + ENDPOINT_SEARCH_TWEETS, conf.getSigningRestBaseURL()
                        + ENDPOINT_SEARCH_TWEETS,
                        query.asHttpParameterArray(INCLUDE_ENTITIES, INCLUDE_RTS)), query);
    }

    @Override
    public ResponseList<Place> searchPlaces(final GeoQuery query) throws TwitterException {
        return factory.createPlaceList(get(conf.getRestBaseURL() + ENDPOINT_GEO_SEARCH,
                conf.getSigningRestBaseURL()
    ...
    public ResponseList<User> searchUsers(final String query, final int page)
            throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createUserList(get(conf.getRestBaseURL() + ENDPOINT_USERS_SEARCH,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_USERS_SEARCH, new HttpParameter("q", query), new HttpParameter(
                        "per_page", 20),
    ...
    public DirectMessage sendDirectMessage(final long userId, final String text)
        ...
        return factory.createDirectMessage(post(conf.getRestBaseURL()
                ...
                conf.getSigningRestBaseURL() + ENDPOINT_DIRECT_MESSAGES_NEW, new HttpParameter(
                        "user_id", userId),
    ...
    public DirectMessage showDirectMessage(final long id) throws TwitterException {
        ...
        return factory.createDirectMessage(get(conf.getRestBaseURL()
                + ENDPOINT_DIRECT_MESSAGES_SHOW,
                conf.getSigningRestBaseURL() + ENDPOINT_DIRECT_MESSAGES_SHOW, new HttpParameter(
                        "id", id),
                INCLUDE_ENTITIES));
    }
    ...
    public Relationship showFriendship(final long sourceId, final long targetId)
        ...
        return factory.createRelationship(get(conf.getRestBaseURL() + ENDPOINT_FRIENDSHIPS_SHOW,
                conf.getSigningRestBaseURL() + ENDPOINT_FRIENDSHIPS_SHOW, new HttpParameter(
                        "source_id", sourceId),
    ...
    public Relationship showFriendship(final String sourceScreenName, final String targetScreenName)
            throws TwitterException {
        return factory.createRelationship(get(
                conf.getRestBaseURL() + ENDPOINT_FRIENDSHIPS_SHOW,
                conf.getSigningRestBaseURL() + ENDPOINT_FRIENDSHIPS_SHOW,
                getParameterArray("source_screen_name", sourceScreenName, "target_screen_name",
                        targetScreenName)));
    }
    ...
    public Status showStatus(final long id) throws TwitterException {
        return factory.createStatus(get(conf.getRestBaseURL() + ENDPOINT_STATUSES_SHOW,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_STATUSES_SHOW, new HttpParameter("id", id), INCLUDE_ENTITIES,
                INCLUDE_MY_RETWEET));
    }

    @Override
    public User showUser(final long userId) throws TwitterException {
        return factory.createUser(get(conf.getRestBaseURL() + ENDPOINT_USERS_SHOW,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_USERS_SHOW, new HttpParameter("user_id", userId),
                INCLUDE_ENTITIES));
    }
    ...
    public User showUser(final String screenName) throws TwitterException {
        return factory.createUser(get(conf.getRestBaseURL() + ENDPOINT_USERS_SHOW,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_USERS_SHOW, new HttpParameter("screen_name", screenName),
                INCLUDE_ENTITIES));
    }

    @Override
    public UserList showUserList(final int listId) throws TwitterException {
        return factory.createAUserList(get(conf.getRestBaseURL() + ENDPOINT_LISTS_SHOW,
                conf.getSigningRestBaseURL()
    ...
    public UserList showUserList(final String slug, final long ownerId) throws TwitterException {
        return factory.createAUserList(get(conf.getRestBaseURL() + ENDPOINT_LISTS_SHOW,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_LISTS_SHOW, new HttpParameter("slug", slug), new HttpParameter(
                        "owner_id", ownerId)));
    }

    @Override
    public UserList showUserList(final String slug, final String ownerScreenName)
            throws TwitterException {
        return factory.createAUserList(get(conf.getRestBaseURL() + ENDPOINT_LISTS_SHOW,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_LISTS_SHOW, new HttpParameter("slug", slug), new HttpParameter(
    ...
    public User showUserListMembership(final int listId, final long userId) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createUser(get(conf.getRestBaseURL() + ENDPOINT_LISTS_MEMBERS_SHOW,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_LISTS_MEMBERS_SHOW, new HttpParameter("list_id", listId),
                new HttpParameter("user_id",
    ...
    public User showUserListSubscription(final int listId, final long userId)
        ...
        return factory.createUser(get(conf.getRestBaseURL() + ENDPOINT_LISTS_SUBSCRIBERS_SHOW,
                conf.getSigningRestBaseURL() + ENDPOINT_LISTS_SUBSCRIBERS_SHOW, new HttpParameter(
                        "list_id", listId),
    ...
    public String toString() {
        return "TwitterImpl{" + "INCLUDE_ENTITIES=" + INCLUDE_ENTITIES + ", INCLUDE_RTS="
                + INCLUDE_RTS + '}';
    }

    @Override
    public AccountSettings updateAccountSettings(final Integer trend_locationWoeid,
            final Boolean sleep_timeEnabled,
            final String start_sleepTime, final String end_sleepTime, final String time_zone,
            final String lang)
            throws TwitterException {
        ...
        return factory.createAccountSettings(post(
                conf.getRestBaseURL() + ENDPOINT_ACCOUNT_SETTINGS,
                conf.getSigningRestBaseURL() + ENDPOINT_ACCOUNT_SETTINGS,
                params.toArray(new HttpParameter[params.size()])));
    }
    ...
    public Relationship updateFriendship(final long userId, final boolean enableDeviceNotification,
        ...
        return factory.createRelationship(post(conf.getRestBaseURL() + ENDPOINT_FRIENDSHIPS_UPDATE,
                conf.getSigningRestBaseURL() + ENDPOINT_FRIENDSHIPS_UPDATE, new HttpParameter(
                        "user_id", userId),
                new HttpParameter("device", enableDeviceNotification), new HttpParameter(
                        "retweets",
    ...
    public Relationship updateFriendship(final String screenName,
        ...
        return factory.createRelationship(post(conf.getRestBaseURL() + ENDPOINT_FRIENDSHIPS_UPDATE,
                ...
                new HttpParameter("screen_name", screenName), new HttpParameter("device",
                        enableDeviceNotification),
    ...
    public User updateProfileBackgroundImage(final File image, final boolean tile)
        ...
        return factory.createUser(post(conf.getRestBaseURL()
                ...
                conf.getSigningRestBaseURL() + ENDPOINT_ACCOUNT_UPDATE_PROFILE_BACKGROUND_IMAGE,
                new HttpParameter(
        ...
        return factory
                .createUser(post(conf.getRestBaseURL()
                        ...
                        conf.getSigningRestBaseURL()
                                + ENDPOINT_ACCOUNT_UPDATE_PROFILE_BACKGROUND_IMAGE,
                        new HttpParameter(
                                "image", "image", image), new HttpParameter("tile", tile),
                        INCLUDE_ENTITIES));
    }
    ...
    public void updateProfileBannerImage(final File banner) throws TwitterException {
        ...
        post(conf.getRestBaseURL() + ENDPOINT_ACCOUNT_UPDATE_PROFILE_BANNER,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_ACCOUNT_UPDATE_PROFILE_BANNER, new HttpParameter("banner",
                        banner));
    }

    @Override
    public void updateProfileBannerImage(final File banner, final int width, final int height,
    ...
    @Override
    public void updateProfileBannerImage(final InputStream banner, final int width,
            final int height,
    ...
    public User updateProfileColors(final String profileBackgroundColor,
        ...
        params.add(INCLUDE_ENTITIES);
        return factory.createUser(post(conf.getRestBaseURL()
                + ENDPOINT_ACCOUNT_UPDATE_PROFILE_COLORS,
    ...
    public Status updateStatus(final StatusUpdate status) throws TwitterException {
        ...
        final String url = conf.getRestBaseURL()
                + (status.isWithMedia() ? ENDPOINT_STATUSES_UPDATE_WITH_MEDIA
                        : ENDPOINT_STATUSES_UPDATE);
        final String sign_url = conf.getSigningRestBaseURL()
                + (status.isWithMedia() ? ENDPOINT_STATUSES_UPDATE_WITH_MEDIA
                        : ENDPOINT_STATUSES_UPDATE);
        return factory.createStatus(post(url, sign_url,
    ...
    public Status updateStatus(final String status) throws TwitterException {
        ensureAuthorizationEnabled();
        return factory.createStatus(post(conf.getRestBaseURL() + ENDPOINT_STATUSES_UPDATE,
                conf.getSigningRestBaseURL()
                        + ENDPOINT_STATUSES_UPDATE, new HttpParameter("status", status),
                INCLUDE_ENTITIES));
    }
    ...
    public UserList updateUserList(final int listId, final String newListName,
        ...
        return factory.createAUserList(post(conf.getRestBaseURL() + ENDPOINT_LISTS_UPDATE,
                conf.getSigningRestBaseURL()
