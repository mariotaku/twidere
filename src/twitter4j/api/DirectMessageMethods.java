...
public interface DirectMessageMethods {
	 ...
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/post/direct_messages/destroy/:id">POST
	 ...
	 * @return List
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1/get/direct_messages">GET
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/get/direct_messages/sent">GET
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/post/direct_messages/new">POST
