...
public interface FavoriteMethods {
	 ...
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/post/favorites/create/:id">POST
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/post/favorites/destroy/:id">POST
	 ...
	 * @return List<Status>
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1/get/favorites">GET
	 ...
	 * @since Twitter4J 2.0.1
	 */
	ResponseList<Status> getFavorites(String id) throws TwitterException;
	 ...
	 * @since Twitter4J 2.0.1
	 */
	ResponseList<Status> getFavorites(String id, int page) throws TwitterException;
	 ...
	 * @since Twitter4J 2.2.5
	 */
	ResponseList<Status> getFavorites(String id, Paging paging) throws TwitterException;
}
