...
public interface ListMembersMethods {
	 ...
	 */
	@Deprecated
	User checkUserListMembership(String listOwnerScreenName, int listId, long userId) throws TwitterException;
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/get/:user/:list_id/members">GET
	 *      :user/:list_id/members | Twitter Developers</a>
	 * @since Twitter4J 2.1.0
	 * @deprecated use {@link #getUserListMembers(int, long)} instead
	 */
	@Deprecated
	PagableResponseList<User> getUserListMembers(long listOwnerId, int listId, long cursor) throws TwitterException;
