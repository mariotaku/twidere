...
public interface ListSubscribersMethods {
	 ...
	 */
	@Deprecated
	User checkUserListSubscription(String listOwnerScreenName, int listId, long userId) throws TwitterException;
	 ...
	 */
	@Deprecated
	UserList subscribeUserList(String listOwnerScreenName, int listId) throws TwitterException;

	/**
	 * Unsubscribes the authenticated user form the specified list. <br>
	 * This method calls
	 * http://api.twitter.com/1/:listOwner/:listId/subscribers.json
	 * 
	 * @param listOwnerScreenName The screen name of the list owner
	 * @param listId The id of the list.
	 * @return the updated list
	 ...
	 */
	@Deprecated
	UserList unsubscribeUserList(String listOwnerScreenName, int listId) throws TwitterException;
}
