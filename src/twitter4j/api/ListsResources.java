...
public interface ListsResources {
     ...
     * @since Twitter4J 2.2.3
     */
    PagableResponseList<User> getUserListMembers(int listId, CursorPaging paging)
            throws TwitterException;

    PagableResponseList<User> getUserListMembers(String slug, long ownerId, CursorPaging paging)
            throws TwitterException;

    PagableResponseList<User> getUserListMembers(String slug, String ownerScreenName,
            CursorPaging paging)
            throws TwitterException;
    ...
    ResponseList<Status> getUserListStatuses(String slug, long ownerId, Paging paging)
            throws TwitterException;
     ...
     * @since Twitter4J 2.2.3
     */
    PagableResponseList<User> getUserListSubscribers(int listId, CursorPaging paging)
            throws TwitterException;

    PagableResponseList<User> getUserListSubscribers(String slug, long ownerId, CursorPaging paging)
            throws TwitterException;

    PagableResponseList<User> getUserListSubscribers(String slug, String ownerScreenName,
            CursorPaging paging)
            throws TwitterException;
     ...
     * @since Twitter4J 2.1.0
     */
    UserList updateUserList(int listId, String newListName, boolean isPublicList,
