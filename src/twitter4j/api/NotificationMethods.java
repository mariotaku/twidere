...
public interface NotificationMethods {
	 ...
	 */
	User disableNotification(long userId) throws TwitterException;
	 ...
	 */
	User disableNotification(String screenName) throws TwitterException;
	 ...
	 * @since Twitter4J 2.1.0
	 */
	User enableNotification(long userId) throws TwitterException;
	 ...
	 * @since Twitter4J 2.0.1
	 */
	User enableNotification(String screenName) throws TwitterException;
}
