...
public interface SavedSearchesMethods {
	 ...
	 * This method calls
	 * http://api.twitter.com/1/saved_searches/saved_searches/create.json
	 * 
	 * @param query the query string
	 * @return the data for a created saved search
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/post/saved_searches/create">POST
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/post/saved_searches/destroy/:id">POST
	 ...
	 *         blocking.
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1/get/saved_searches">GET
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/get/saved_searches/show/:id">GET
