...
public interface StatusMethods {
	 ...
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/post/statuses/destroy/:id">POST
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/get/statuses/:id/retweeted_by">GET
	 *      statuses/:id/retweeted_by | Twitter Developers</a>
	...
	/**
	 * Show user ids of up to 100 users who retweeted the status represented by
	 * id <br />
	 * This method calls
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/get/statuses/:id/retweeted_by/ids">GET
	 *      statuses/:id/retweeted_by/ids | Twitter Developers</a>
	 * @since Twitter4J 2.1.3
	 * @deprecated use {@link #getRetweetedByIDs(long, twitter4j.Paging)}
	 *             instead
	 */
	@Deprecated
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/get/statuses/retweets/:id">Tweets
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/post/statuses/retweet/:id">POST
	 ...
	 *             unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/get/statuses/show/:id">GET
	 ...
	 * duplicates. <br>
	 * This method calls http://api.twitter.com/1/statuses/update or<br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/post/statuses/update">POST
