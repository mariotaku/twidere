...
public interface TrendsMethods {
	 ...
	 * @see <a href="https://dev.twitter.com/docs/api/1/get/trends/daily">GET
	 *      trends/daily | Twitter Developers</a>
	 ...
	 * @param excludeHashTags Setting this to true will remove all hashtags from
	 *            the trends list.
	 * @return the result
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1/get/trends/daily">GET
	 ...
	 * @since Twitter4J 2.0.2
	 */
	ResponseList<Trends> getDailyTrends(Date date, boolean excludeHashTags) throws TwitterException;
	 ...
	 * @return the result
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1/get/trends/weekly">GET
	 *      trends/weekly | Twitter Developers</a>
	 * @since Twitter4J 2.0.2
	 */
	 ...
	 * @since Twitter4J 2.0.2
	 */
	ResponseList<Trends> getWeeklyTrends(Date date, boolean excludeHashTags) throws TwitterException;
}
