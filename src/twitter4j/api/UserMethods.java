...
public interface UserMethods {
	 ...
	 * 
	 * @param cursor Breaks the results into pages. A single page contains 100
	 *            users. This is recommended for users who are followed by many
	 *            other users. Provide a value of -1 to begin paging. Provide
	 *            values as returned to in the response body's next_cursor and
	 *            previous_cursor attributes to page back and forth in the list.
	 * @return List
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/get/statuses/followers">GET
	 *      statuses/followers | Twitter Developers</a>
	 * @since Twitter4J 2.0.9
	 * @deprecated use {@link FriendsFollowersMethods#getFollowersIDs(long)} and
	 *             {@link UserMethods#lookupUsers(long[])} instead
	 */
	@Deprecated
	PagableResponseList<User> getFollowersStatuses(long cursor) throws TwitterException;

	/**
	 * Returns the specified user's followers, each with current status inline.
	 * They are ordered by the order in which they joined Twitter (this is going
	 * to be changed). <br>
	 * This method calls http://api.twitter.com/1/statuses/followers.json
	 * 
	 ...
	 * @deprecated use
	 *             {@link FriendsFollowersMethods#getFollowersIDs(long, long)}
	 *             and {@link UserMethods#lookupUsers(long[])} instead
	 */
	@Deprecated
	PagableResponseList<User> getFollowersStatuses(long userId, long cursor) throws TwitterException;
	 ...
	 * @since Twitter4J 2.0.9
	 * @deprecated use
	 *             {@link FriendsFollowersMethods#getFollowersIDs(String, long)}
	 *             and {@link UserMethods#lookupUsers(long[])} instead
	 */
	@Deprecated
	PagableResponseList<User> getFollowersStatuses(String screenName, long cursor) throws TwitterException;
	 ...
	 * guaranteed to be 100 every time as suspended users will be filtered out.) <br>
	 ...
	 * @throws TwitterException when Twitter service or network is unavailable
	 * @see <a
	 *      href="https://dev.twitter.com/docs/api/1/get/statuses/friends">GET
	 *      statuses/friends | Twitter Developers</a>
	 * @since Twitter4J 2.0.9
	 * @deprecated use {@link FriendsFollowersMethods#getFriendsIDs(long)} and
	 *             {@link UserMethods#lookupUsers(long[])} instead
	 */
	@Deprecated
	PagableResponseList<User> getFriendsStatuses(long cursor) throws TwitterException;
	 ...
	 *      statuses/friends | Twitter Developers</a>
	 * @since Twitter4J 2.1.0
	 * @deprecated use {@link FriendsFollowersMethods#getFriendsIDs(long, long)}
	 *             and {@link UserMethods#lookupUsers(long[])} instead
	 */
	@Deprecated
	PagableResponseList<User> getFriendsStatuses(long userId, long cursor) throws TwitterException;
	 ...
	 * @since Twitter4J 2.0.9
	 * @deprecated use
	 *             {@link FriendsFollowersMethods#getFriendsIDs(String, long)}
	 *             and {@link UserMethods#lookupUsers(long[])} instead
	 */
	@Deprecated
	PagableResponseList<User> getFriendsStatuses(String screenName, long cursor) throws TwitterException;
	 ...
	 * screen_name. If no size is provided the normal image is returned. This
	 * resource does not return JSON or XML, but instead returns a 302 redirect
	 * to the actual image resource. This method should only be used by
	 * application developers to lookup or check the profile image URL for a
	 ...
	 *            for.
	 * @param size Specifies the size of image to fetch. Not specifying a size
	 *            will give the default, normal size of 48px by 48px. Valid
	 *            options include: BIGGER - 73px by 73px NORMAL - 48px by 48px
	 *            MINI - 24px by 24px
