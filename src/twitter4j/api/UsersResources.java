...
public interface UsersResources {
     ...
     */
    AccountSettings updateAccountSettings(Integer trendLocationWoeid, Boolean sleepTimeEnabled,
     ...
     *             nested)
     */
    void updateProfileBannerImage(InputStream banner, int width, int height, int offsetLeft,
            int offsetTop)
            throws TwitterException;
     ...
     */
    User updateProfileColors(String profileBackgroundColor, String profileTextColor,
