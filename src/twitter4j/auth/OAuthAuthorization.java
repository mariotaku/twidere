...
public class OAuthAuthorization implements Authorization, OAuthSupport {
    ...
    private static final HttpParameter OAUTH_SIGNATURE_METHOD = new HttpParameter(
    ...
    public OAuthAuthorization(final Configuration conf) {
        ...
        if (conf.getOAuthAccessToken() != null && conf.getOAuthAccessTokenSecret() != null) {
            setOAuthAccessToken(new AccessToken(conf.getOAuthAccessToken(),
    ...
    public boolean equals(final Object o) {
        ...
        if (consumerKey != null ? !consumerKey.equals(that.consumerKey) : that.consumerKey != null)
            return false;
        if (consumerSecret != null ? !consumerSecret.equals(that.consumerSecret)
                : that.consumerSecret != null)
            return false;
    ...
    public List<HttpParameter> generateOAuthSignatureHttpParams(final String method,
        ...
        final List<HttpParameter> signatureBaseParams = new ArrayList<HttpParameter>(
    ...
    public String getAuthorizationHeader(final HttpRequest req) {
        return generateAuthorizationHeader(req.getMethod().name(), req.getSignURL(),
    ...
    public AccessToken getOAuthAccessToken() throws TwitterException {
        ...
        oauthToken = new AccessToken(http.post(conf.getOAuthAccessTokenURL(),
                conf.getSigningOAuthAccessTokenURL(),
                this));
        return (AccessToken) oauthToken;
    }
    ...
    public AccessToken getOAuthAccessToken(final String oauthVerifier) throws TwitterException {
        ...
        oauthToken = new AccessToken(http.post(url, sign_url, new HttpParameter[] {
            new HttpParameter("oauth_verifier",
                    oauthVerifier)
        }, this));
        return (AccessToken) oauthToken;
    }
    ...
    public AccessToken getOAuthAccessToken(final String screenName, final String password)
        ...
        try {
            ...
            throw new TwitterException(
                    "The screen name / password combination seems to be invalid.", te,
                    te.getStatusCode());
        }
    }
    ...
    public RequestToken getOAuthRequestToken(final String callbackURL, final String xAuthAccessType)
        ...
        oauthToken = new RequestToken(conf, http.post(url, sign_url,
        ...
        if (-1 != queryStart) {
            ...
            try {
                for (final String query : queryStrs) {
                    ...
                    if (split.length == 2) {
                        signatureBaseParams.add(new HttpParameter(URLDecoder.decode(split[0],
                                "UTF-8"), URLDecoder
    ...
    /* package */String generateAuthorizationHeader(final String method, final String sign_url,
        ...
        final long timestamp = System.currentTimeMillis() / 1000;
        final long nonce = timestamp + RAND.nextInt();
        return generateAuthorizationHeader(method, sign_url, params, String.valueOf(nonce),
