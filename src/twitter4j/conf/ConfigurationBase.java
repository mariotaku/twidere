...
class ConfigurationBase implements TwitterConstants, Configuration {
    ...
    public boolean equals(final Object obj) {
        ...
        if (debug != other.debug)
            return false;
        if (defaultMaxPerRoute != other.defaultMaxPerRoute)
            return false;
        ...
        if (httpClientImplementation == null) {
            if (other.httpClientImplementation != null)
                return false;
        } else if (!httpClientImplementation.equals(other.httpClientImplementation))
            return false;
        if (httpConnectionTimeout != other.httpConnectionTimeout)
            return false;
        ...
        if (httpProxyPassword == null) {
            if (other.httpProxyPassword != null)
                return false;
        } else if (!httpProxyPassword.equals(other.httpProxyPassword))
            return false;
        if (httpProxyPort != other.httpProxyPort)
            return false;
        if (httpProxyUser == null) {
            if (other.httpProxyUser != null)
                return false;
        } else if (!httpProxyUser.equals(other.httpProxyUser))
            return false;
        if (httpReadTimeout != other.httpReadTimeout)
            return false;
        ...
        if (includeRTsEnabled != other.includeRTsEnabled)
            return false;
        if (includeTwitterClientHeader != other.includeTwitterClientHeader)
            return false;
        ...
        if (password == null) {
            ...
            return false;
        if (prettyDebug != other.prettyDebug)
            return false;
    ...
    public String getSigningOAuthAccessTokenURL() {
        return signingOAuthAccessTokenURL != null ? signingOAuthAccessTokenURL
                : oAuthAccessTokenURL;
    }

    @Override
    public String getSigningOAuthAuthenticationURL() {
        return signingOAuthAuthenticationURL != null ? signingOAuthAuthenticationURL
                : oAuthAuthenticationURL;
    }

    @Override
    public String getSigningOAuthAuthorizationURL() {
        return signingOAuthAuthorizationURL != null ? signingOAuthAuthorizationURL
    ...
    public String getSigningOAuthRequestTokenURL() {
        return signingOAuthRequestTokenURL != null ? signingOAuthRequestTokenURL
    ...
    public int hashCode() {
        ...
        result = prime * result
                + (hostAddressResolver == null ? 0 : hostAddressResolver.hashCode());
        result = prime * result
                + (httpClientImplementation == null ? 0 : httpClientImplementation.hashCode());
        ...
        result = prime * result
                + (oAuthAccessTokenSecret == null ? 0 : oAuthAccessTokenSecret.hashCode());
        result = prime * result
                + (oAuthAccessTokenURL == null ? 0 : oAuthAccessTokenURL.hashCode());
        result = prime * result
                + (oAuthAuthenticationURL == null ? 0 : oAuthAuthenticationURL.hashCode());
        result = prime * result
                + (oAuthAuthorizationURL == null ? 0 : oAuthAuthorizationURL.hashCode());
        ...
        result = prime * result
                + (oAuthConsumerSecret == null ? 0 : oAuthConsumerSecret.hashCode());
        result = prime * result
                + (oAuthRequestTokenURL == null ? 0 : oAuthRequestTokenURL.hashCode());
        ...
        result = prime * result
                + (signingOAuthAccessTokenURL == null ? 0 : signingOAuthAccessTokenURL.hashCode());
        result = prime
                * result
                + (signingOAuthAuthenticationURL == null ? 0 : signingOAuthAuthenticationURL
                        .hashCode());
        result = prime
                * result
                + (signingOAuthAuthorizationURL == null ? 0 : signingOAuthAuthorizationURL
                        .hashCode());
        result = prime * result
                + (signingOAuthBaseURL == null ? 0 : signingOAuthBaseURL.hashCode());
        result = prime
                * result
                + (signingOAuthRequestTokenURL == null ? 0 : signingOAuthRequestTokenURL.hashCode());
    ...
    public boolean isProxyConfigured() {
        return (getHttpProxyHost() != null || "".equals(getHttpProxyHost()))
                && getHttpProxyPort() > 0;
    }
    ...
    public void setHttpClientImplementation(
            final Class<? extends HttpClient> httpClientImplementation) {
        if (httpClientImplementation != null) {
            try {
    ...
    public String toString() {
        return "ConfigurationBase{debug=" + debug + ", userAgent=" + userAgent + ", user=" + user
                + ", password="
                + password + ", useSSL=" + useSSL + ", ignoreSSLError=" + ignoreSSLError
                + ", prettyDebug="
                ...
                + ", httpProxyPort="
                + httpProxyPort + ", httpConnectionTimeout=" + httpConnectionTimeout
                + ", httpReadTimeout="
                + httpReadTimeout + ", httpClientImplementation=" + httpClientImplementation
                + ", httpRetryCount="
                + httpRetryCount + ", httpRetryIntervalSeconds=" + httpRetryIntervalSeconds
                + ", maxTotalConnections="
                + maxTotalConnections + ", defaultMaxPerRoute=" + defaultMaxPerRoute
                + ", oAuthConsumerKey="
                + oAuthConsumerKey + ", oAuthConsumerSecret=" + oAuthConsumerSecret
                + ", oAuthAccessToken="
                + oAuthAccessToken + ", oAuthAccessTokenSecret=" + oAuthAccessTokenSecret
                + ", oAuthRequestTokenURL="
                + oAuthRequestTokenURL + ", oAuthAuthorizationURL=" + oAuthAuthorizationURL
                + ", oAuthAccessTokenURL="
                ...
                + signingOAuthAuthorizationURL + ", signingOAuthAccessTokenURL="
                + signingOAuthAccessTokenURL
                + ", signingOAuthAuthenticationURL=" + signingOAuthAuthenticationURL
                + ", oAuthBaseURL=" + oAuthBaseURL
                + ", signingOAuthBaseURL=" + signingOAuthBaseURL + ", signingRestBaseURL="
                + signingRestBaseURL
                + ", restBaseURL=" + restBaseURL + ", includeRTsEnabled=" + includeRTsEnabled
                + ", includeEntitiesEnabled=" + includeEntitiesEnabled
                + ", includeTwitterClientHeader="
                + includeTwitterClientHeader + ", clientVersion=" + clientVersion + ", clientURL="
                + clientURL
    ...
    private void fixOAuthBaseURL() {
        ...
        if (oAuthBaseURL != null
                && oAuthBaseURL.equals(fixURL(DEFAULT_USE_SSL, signingOAuthBaseURL))) {
            signingOAuthBaseURL = fixURL(useSSL, signingOAuthBaseURL);
        }
        if (oAuthBaseURL != null
                && (oAuthBaseURL + PATH_SEGMENT_ACCESS_TOKEN).equals(fixURL(DEFAULT_USE_SSL,
                        oAuthAccessTokenURL))) {
            oAuthAccessTokenURL = fixURL(useSSL, oAuthAccessTokenURL);
        }
        if (oAuthBaseURL != null
                && (oAuthBaseURL + PATH_SEGMENT_AUTHENTICATION).equals(fixURL(DEFAULT_USE_SSL,
                        oAuthAuthenticationURL))) {
            oAuthAuthenticationURL = fixURL(useSSL, oAuthAuthenticationURL);
        }
        if (oAuthBaseURL != null
                && (oAuthBaseURL + PATH_SEGMENT_AUTHORIZATION).equals(fixURL(DEFAULT_USE_SSL,
                        oAuthAuthorizationURL))) {
            oAuthAuthorizationURL = fixURL(useSSL, oAuthAuthorizationURL);
        }
        if (oAuthBaseURL != null
                && (oAuthBaseURL + PATH_SEGMENT_REQUEST_TOKEN).equals(fixURL(DEFAULT_USE_SSL,
                        oAuthRequestTokenURL))) {
