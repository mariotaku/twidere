...
public final class ConfigurationBuilder {
    ...
    public ConfigurationBuilder setHttpClientImplementation(
    ...
    public ConfigurationBuilder setIncludeTwitterClientHeader(
            final boolean includeTwitterClientHeader) {
        checkNotBuilt();
