...
class AccountSettingsJSONImpl extends TwitterResponseImpl implements AccountSettings {
    ...
    private AccountSettingsJSONImpl(final HttpResponse res, final JSONObject json)
    ...
    /* package */AccountSettingsJSONImpl(final HttpResponse res, final Configuration conf)
            throws TwitterException {
