...
class AccountTotalsJSONImpl extends TwitterResponseImpl implements AccountTotals {
    ...
    /* package */AccountTotalsJSONImpl(final HttpResponse res, final Configuration conf)
    ...
    public boolean equals(final Object o) {
        ...
        if (favorites != that.favorites)
            return false;
        if (followers != that.followers)
            return false;
        if (friends != that.friends)
            return false;
        if (updates != that.updates)
            return false;
    ...
    public String toString() {
        return "AccountTotalsJSONImpl{" + "updates=" + updates + ", followers=" + followers
                + ", favorites="
