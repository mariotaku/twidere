...
public class InternalJSONFactoryImpl implements InternalJSONFactory {
    ...
    @Override
    public ResponseList<Activity> createActivityList(final HttpResponse res)
    ...
    @Override
    public ResponseList<Category> createCategoryList(final HttpResponse res)
            throws TwitterException {
    ...
    @Override
    public ResponseList<DirectMessage> createDirectMessageList(final HttpResponse res)
            throws TwitterException {
    ...
    @Override
    public ResponseList<Friendship> createFriendshipList(final HttpResponse res)
            throws TwitterException {
    ...
    @Override
    public ResponseList<HelpResources.Language> createLanguageList(final HttpResponse res)
            throws TwitterException {
        return LanguageJSONImpl.createLanguageList(res, conf);
    }

    @Override
    public ResponseList<Location> createLocationList(final HttpResponse res)
            throws TwitterException {
    ...
    @Override
    public PagableResponseList<User> createPagableUserList(final HttpResponse res)
            throws TwitterException {
        return UserJSONImpl.createPagableUserList(res, conf);
    }

    @Override
    public PagableResponseList<UserList> createPagableUserListList(final HttpResponse res)
            throws TwitterException {
    ...
    @Override
    public QueryResult createQueryResult(final HttpResponse res, final Query query)
            throws TwitterException {
        try {
    ...
    @Override
    public Map<String, RateLimitStatus> createRateLimitStatus(final HttpResponse res)
            throws TwitterException {
    ...
    @Override
    public ResponseList<SavedSearch> createSavedSearchList(final HttpResponse res)
            throws TwitterException {
    ...
    @Override
    public TwitterAPIConfiguration createTwitterAPIConfiguration(final HttpResponse res)
            throws TwitterException {
    ...
    @Override
    public ResponseList<User> createUserListFromJSONArray(final HttpResponse res)
            throws TwitterException {
        return UserJSONImpl.createUserList(res.asJSONArray(), res, conf);
    }

    @Override
    public ResponseList<User> createUserListFromJSONArray_Users(final HttpResponse res)
            throws TwitterException {
        try {
    ...
    @Override
    public ResponseList<UserList> createUserListList(final HttpResponse res)
            throws TwitterException {
    ...
    public boolean equals(final Object o) {
        if (this == o)
            return true;
        if (!(o instanceof InternalJSONFactoryImpl))
            return false;
     ...
     */
    public static HashtagEntity createHashtagEntity(final int start, final int end,
            final String text) {
     ...
     * @since Twitter4J 2.2.6
     */
    public static URLEntity createUrlEntity(final int start, final int end, final String url,
     ...
     * @since Twitter4J 2.2.6
     */
    public static UserMentionEntity createUserMentionEntity(final int start, final int end,
            final String name,
    ...
    /* package */
    static GeoLocation[][] coordinatesAsGeoLocationArray(final JSONArray coordinates)
            throws TwitterException {
        try {
            ...
            for (int i = 0; i < coordinates.length(); i++) {
                ...
                for (int j = 0; j < array.length(); j++) {
                    ...
                    boundingBox[i][j] = new GeoLocation(coordinate.getDouble(1),
