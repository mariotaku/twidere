...
/* package */final class LocationJSONImpl implements Location {
    ...
    public String toString() {
        return "LocationJSONImpl{" + "woeid=" + woeid + ", countryName='" + countryName + '\''
                + ", countryCode='"
                + countryCode + '\'' + ", placeName='" + placeName + '\'' + ", placeCode='"
                + placeCode + '\''
                + ", name='" + name + '\'' + ", url='" + url + '\'' + '}';
    }

    /* package */
    static ResponseList<Location> createLocationList(final HttpResponse res,
