...
public class MediaEntityJSONImpl implements MediaEntity {
    ...
    public String toString() {
        return "MediaEntityJSONImpl{" + "id=" + id + ", start=" + start + ", end=" + end + ", url="
                + url
                + ", mediaURL=" + mediaURL + ", mediaURLHttps=" + mediaURLHttps + ", expandedURL="
                + expandedURL
                + ", displayURL='" + displayURL + '\'' + ", sizes=" + sizes + ", type=" + type
                + '}';
    }

    private void addMediaEntitySizeIfNotNull(final Map<Integer, MediaEntity.Size> sizes,
            final JSONObject sizes_json,
    ...
    static class Size implements MediaEntity.Size {
        ...
        Size(final JSONObject json) throws JSONException {
            ...
            resize = "fit".equals(json.getString("resize")) ? MediaEntity.Size.FIT
                    : MediaEntity.Size.CROP;
        }
