...
public class OEmbedJSONImpl extends TwitterResponseImpl implements OEmbed, java.io.Serializable {
    ...
    /* package */OEmbedJSONImpl(final HttpResponse res, final Configuration conf)
    ...
    public String toString() {
        return "OEmbedJSONImpl{" + "html='" + html + '\'' + ", authorName='" + authorName + '\''
                + ", url='" + url
                + '\'' + ", version='" + version + '\'' + ", cacheAge=" + cacheAge
                + ", authorURL='" + authorURL + '\''
                + ", width=" + width + '}';
    }
