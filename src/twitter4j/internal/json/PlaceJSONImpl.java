...
final class PlaceJSONImpl extends TwitterResponseImpl implements Place {
    ...
    /* package */PlaceJSONImpl(final HttpResponse res, final Configuration conf)
    ...
    public String toString() {
        return "PlaceJSONImpl{" + "name='" + name + '\'' + ", streetAddress='" + streetAddress
                + '\''
                + ", countryCode='" + countryCode + '\'' + ", id='" + id + '\'' + ", country='"
                + country + '\''
                + ", placeType='" + placeType + '\'' + ", url='" + url + '\'' + ", fullName='"
                + fullName + '\''
                + ", boundingBoxType='" + boundingBoxType + '\'' + ", boundingBoxCoordinates="
                + (boundingBoxCoordinates == null ? null : Arrays.asList(boundingBoxCoordinates))
                + ", geometryType='"
                + geometryType + '\'' + ", geometryCoordinates="
                + (geometryCoordinates == null ? null : Arrays.asList(geometryCoordinates))
                + ", containedWithIn="
    ...
    private void init(final JSONObject json) throws TwitterException {
        try {
            ...
            if (!json.isNull("bounding_box")) {
                ...
                boundingBoxCoordinates = InternalJSONFactoryImpl
                        .coordinatesAsGeoLocationArray(array);
            } else {
            ...
            if (!json.isNull("geometry")) {
                ...
                if (geometryType.equals("Point")) {
                    ...
                    geometryCoordinates[0][0] = new GeoLocation(array.getDouble(0),
                            array.getDouble(1));
                } else if (geometryType.equals("Polygon")) {
                    geometryCoordinates = InternalJSONFactoryImpl
                            .coordinatesAsGeoLocationArray(array);
                } else {
