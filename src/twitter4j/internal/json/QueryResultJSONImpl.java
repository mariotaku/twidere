...
/* package */final class QueryResultJSONImpl implements QueryResult {
    ...
    public boolean equals(final Object o) {
        ...
        if (page != that.getPage())
            return false;
        if (resultsPerPage != that.getResultsPerPage())
            return false;
        if (sinceId != that.getSinceId())
            return false;
        if (!query.equals(that.getQuery()))
            return false;
        if (refreshUrl != null ? !refreshUrl.equals(that.getRefreshUrl())
                : that.getRefreshUrl() != null)
            return false;
        if (statuses != null ? !Arrays.equals(statuses, that.getStatuses())
                : that.getStatuses() != null)
            return false;
    ...
    public String toString() {
        return "QueryResultJSONImpl{" + "sinceId=" + sinceId + ", maxId=" + maxId
                + ", refreshUrl='" + refreshUrl
                + '\'' + ", resultsPerPage=" + resultsPerPage + ", warning='" + warning + '\''
                + ", completedIn="
                + completedIn + ", page=" + page + ", query='" + query + '\'' + ", statuses="
                + statuses + '}';
    }
}
