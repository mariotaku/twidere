...
/* package */final class RateLimitStatusJSONImpl implements RateLimitStatus, java.io.Serializable {
    ...
    private RateLimitStatusJSONImpl(final int limit, final int remaining,
            final int resetTimeInSeconds) {
        this.limit = limit;
    ...
    public String toString() {
        return "RateLimitStatusJSONImpl{" + "remaining=" + remaining + ", limit=" + limit
                + ", resetTimeInSeconds="
    ...
    static Map<String, RateLimitStatus> createRateLimitStatuses(final HttpResponse res,
    ...
    static Map<String, RateLimitStatus> createRateLimitStatuses(final JSONObject json)
            throws TwitterException {
        ...
        try {
            ...
            while (resourceKeys.hasNext()) {
                ...
                while (endpointKeys.hasNext()) {
                    ...
                    final RateLimitStatus rateLimitStatus = new RateLimitStatusJSONImpl(
                            rateLimitStatusJSON);
