...
/* package */final class SavedSearchJSONImpl extends TwitterResponseImpl implements SavedSearch {
    ...
    /* package */SavedSearchJSONImpl(final HttpResponse res, final Configuration conf)
    ...
    public String toString() {
        return "SavedSearchJSONImpl{" + "createdAt=" + createdAt + ", query='" + query + '\''
                + ", position="
    ...
    /* package */
    static ResponseList<SavedSearch> createSavedSearchList(final HttpResponse res,
