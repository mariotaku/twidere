...
/* package */final class URLEntityJSONImpl implements URLEntity {
    ...
    /* package */URLEntityJSONImpl(final int start, final int end, final String url,
    ...
    public boolean equals(final Object o) {
        ...
        if (displayURL != null ? !displayURL.equals(that.displayURL) : that.displayURL != null)
            return false;
        if (expandedURL != null ? !expandedURL.toString().equalsIgnoreCase(
                that.expandedURL.toString())
                : that.expandedURL != null)
            return false;
    ...
    public String toString() {
        return "URLEntityJSONImpl{" + "start=" + start + ", end=" + end + ", url=" + url
                + ", expandedURL="
