...
/* package */final class UserJSONImpl extends TwitterResponseImpl implements User {
    ...
    /* package */UserJSONImpl(final HttpResponse res, final Configuration conf)
    ...
    public String toString() {
        return "UserJSONImpl{" + "id=" + id + ", name='" + name + '\'' + ", screenName='"
                + screenName + '\''
                + ", location='" + location + '\'' + ", description='" + description + '\''
                + ", isContributorsEnabled=" + isContributorsEnabled + ", profileImageUrl='"
                + profileImageUrl + '\''
                + ", profileImageUrlHttps='" + profileImageUrlHttps + '\'' + ", url='" + url + '\''
                + ", isProtected="
                ...
                + ", showAllInlineMedia=" + showAllInlineMedia + ", friendsCount=" + friendsCount
                + ", createdAt="
                + createdAt + ", favouritesCount=" + favouritesCount + ", utcOffset=" + utcOffset
                + ", timeZone='"
                ...
                + ", profileBackgroundTiled=" + profileBackgroundTiled + ", lang='" + lang + '\''
                + ", statusesCount="
                + statusesCount + ", isGeoEnabled=" + isGeoEnabled + ", isVerified=" + isVerified
                + ", isTranslator="
                + isTranslator + ", listedCount=" + listedCount + ", isFollowRequestSent="
                + isFollowRequestSent + '}';
    }
    ...
    private void init(final JSONObject json) throws TwitterException {
        try {
            ...
            profileBackgroundImageUrlHttps = getRawString("profile_background_image_url_https",
                    json);
                ...
                try {
                    ...
                    if (!entities.isNull("description")) {
                        ...
                        if (!description.isNull("urls")) {
                            ...
                            for (int i = 0; i < len; i++) {
                                descriptionEntities[i] = new URLEntityJSONImpl(
                                        urlsArray.getJSONObject(i));
                            }
                        }
                    }
    ...
    /* package */
    static PagableResponseList<User> createPagableUserList(final HttpResponse res,
        ...
        try {
            ...
            final PagableResponseList<User> users = new PagableResponseListImpl<User>(size, json,
                    res);
    ...
    /* package */
    static ResponseList<User> createUserList(final HttpResponse res, final Configuration conf)
            throws TwitterException {
        return createUserList(res.asJSONArray(), res, conf);
    }

    /* package */
    static ResponseList<User> createUserList(final JSONArray list, final HttpResponse res,
            final Configuration conf)
            throws TwitterException {
        try {
            final int size = list.length();
