...
/* package */class UserListJSONImpl extends TwitterResponseImpl implements UserList {
    ...
    /* package */UserListJSONImpl(final HttpResponse res, final Configuration conf)
    ...
    public String toString() {
        return "UserListJSONImpl{" + "id=" + id + ", name='" + name + '\'' + ", fullName='"
                + fullName + '\''
                + ", slug='" + slug + '\'' + ", description='" + description + '\''
                + ", subscriberCount="
                + subscriberCount + ", memberCount=" + memberCount + ", uri='" + uri + '\''
                + ", mode=" + mode
    ...
    static PagableResponseList<UserList> createPagableUserListList(final HttpResponse res,
        ...
        try {
            ...
            final PagableResponseList<UserList> users = new PagableResponseListImpl<UserList>(size,
                    json, res);
    ...
    /* package */
    static ResponseList<UserList> createUserListList(final HttpResponse res,
            final Configuration conf)
            throws TwitterException {
        try {
